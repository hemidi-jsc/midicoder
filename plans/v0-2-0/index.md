...
6. `midicoder code build`
7. `midicoder code gen`
8. `midicoder code apply`
9. `midicoder index` (auto-run bắt buộc ngay sau apply)
10. `midicoder runtime test`
11. `midicoder runtime fix`
...
> Ghi chú: file hiện tại là overview tổng thể; file `index-command.md` sẽ mô tả riêng lệnh `midicoder index`.
