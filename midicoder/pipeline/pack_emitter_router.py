...
def _parse_auth_dict(raw: dict[str, Any]) -> Any:
    ...
    from midicoder.packs.cp03_auth.parser import AuthParser
    import yaml
...
def _parse_event_dict(raw: dict[str, Any]) -> Any:
    ...
    from midicoder.packs.cp05_event_driven.parser import EventParser
    parser = EventParser()
...
def _parse_frontend_dict(raw: dict[str, Any]) -> Any:
    ...
    from midicoder.packs.cp18_frontend_framework.parser import FrontendFrameworkParser
    import yaml
...
def _parse_realtime_dict(raw: dict[str, Any]) -> Any:
    ...
    from midicoder.packs.cp22_realtime_ui.parser import RealtimeParser
...
def _parse_geospatial_dict(raw: dict[str, Any]) -> Any:
    ...
    from midicoder.packs.cp35_geospatial.parser import GeospatialParser
...
def _parse_financial_dict(raw: dict[str, Any]) -> Any:
    ...
    from midicoder.packs.cp33_financial.parser import FinancialParser
...
def _parse_onboarding_dict(raw: dict[str, Any]) -> Any:
    ...
    from midicoder.packs.cp36_tenant_onboarding.parser import parse_onboarding_dsl
...
def _parse_tenant_billing_dict(raw: dict[str, Any]) -> Any:
    ...
    from midicoder.packs.cp59_tenant_billing.parser import BillingIR
...
def _parse_mfa_dict(raw: dict[str, Any]) -> Any:
    ...
    from midicoder.packs.cp46_mfa.parser import MFAIR
...
def _parse_rate_limit_dict(raw: dict[str, Any]) -> Any:
    ...
    from midicoder.packs.cp48_rate_limit.parser import RateLimitParser
...
def _parse_notification_dict(raw: dict[str, Any]) -> Any:
    ...
    from midicoder.packs.cp12_notification.parser import (
        parse_channels,
        parse_notifications,
        parse_providers,
    )
...
def _parse_audit_dict(raw: dict[str, Any]) -> Any:
    ...
    from midicoder.packs.cp14_audit_compliance.parser import (
...
def _parse_observability_dict(raw: dict[str, Any]) -> Any:
    ...
    from midicoder.packs.cp15_observability.parser import ObservabilityParser
...
def _parse_kubernetes_dict(raw: dict[str, Any]) -> Any:
    ...
    from midicoder.packs.cp54_kubernetes.parser import K8sIR
...
def _parse_cicd_dict(raw: dict[str, Any]) -> Any:
    ...
    from midicoder.packs.cp55_cicd.parser import CIIR
...
def _parse_encryption_dict(raw: dict[str, Any]) -> Any:
    ...
    from midicoder.packs.cp58_encryption.parser import EncryptionIR
...
def _parse_graphql_federation_dict(raw: dict[str, Any]) -> Any:
    ...
    from midicoder.packs.cp57_graphql_federation.parser import GraphQLIR
