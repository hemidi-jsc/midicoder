...
from midicoder.packs.cp_backend_cache.warm_up import CacheWarmer
...
class TestAngularCacheTemplates:
    ...
    def test_cache_service_template_exists(self):
        ...
        template_path = Path("midicoder/stacks/angular/cp_backend_cache/cache.service.ts.jinja2")
    ...
    def test_cache_interceptor_template_exists(self):
        ...
        template_path = Path("midicoder/stacks/angular/cp_backend_cache/cache.interceptor.ts.jinja2")
        assert template_path.exists()

    def test_cache_module_template_exists(self):
        """Cache module template ton tai."""
        template_path = Path("midicoder/stacks/angular/cp_backend_cache/cache.module.ts.jinja2")
        assert template_path.exists()
...
class TestReactCacheTemplates:
    ...
    def test_use_cache_template_exists(self):
        ...
        template_path = Path("midicoder/stacks/react/cp_backend_cache/useCache.ts.jinja2")
        assert template_path.exists()
    ...
    def test_cache_provider_template_exists(self):
        ...
        template_path = Path("midicoder/stacks/react/cp_backend_cache/CacheProvider.tsx.jinja2")
        assert template_path.exists()

    def test_cache_utils_template_exists(self):
        """cacheUtils template ton tai."""
        template_path = Path("midicoder/stacks/react/cp_backend_cache/cache-utils.ts.jinja2")
        assert template_path.exists()
...
class TestPackYml:
    ...
    def test_pack_yml_exists(self):
        """pack.yml ton tai."""
        pack_path = Path("midicoder/packs/cp_backend_cache/pack.yml")
        assert pack_path.exists()

    def test_changelog_exists(self):
        """CHANGELOG.md ton tai."""
        changelog_path = Path("midicoder/packs/cp_backend_cache/CHANGELOG.md")
...
class TestAngularCacheEmitter:
    ...
    def test_angular_emitter_import(self):
        ...
        from midicoder.packs.cp_backend_cache.angular import AngularEmitter
...
class TestReactCacheEmitter:
    ...
    def test_react_emitter_import(self):
        ...
        from midicoder.packs.cp_backend_cache.react import ReactEmitter
...
class TestConvenienceFunctions:
    ...
    def test_emit_angular_cache_function(self, tmp_path):
        ...
        from midicoder.packs.cp_backend_cache import emit_angular_cache
    ...
    def test_emit_react_cache_function(self, tmp_path):
        ...
        from midicoder.packs.cp_backend_cache import emit_react_cache
