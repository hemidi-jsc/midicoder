...
class TestFastApiEmailService(TestCase):
    ...
    def setUp(self):
        self.template_path = Path("midicoder/stacks/fastapi/cp_full_notification/email_service.py.jinja2")
...
class TestFastApiNotificationService(TestCase):
    ...
    def setUp(self):
        self.template_path = Path("midicoder/stacks/fastapi/cp_full_notification/notification_service.py.jinja2")
...
class TestNestJsNotificationModule(TestCase):
    ...
    def setUp(self):
        self.template_path = Path("midicoder/stacks/nestjs/cp_full_notification/notification.module.ts.jinja2")
...
class TestNestJsEmailService(TestCase):
    ...
    def setUp(self):
        self.template_path = Path("midicoder/stacks/nestjs/cp_full_notification/email.service.ts.jinja2")
