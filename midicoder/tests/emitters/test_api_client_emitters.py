...
class TestAngularApiEmitter:
    ...
    def test_emit_basic_spec(self, tmp_path):
        ...
        from midicoder.emitters.core.cp20_api_client.angular import AngularApiEmitter
...
class TestReactApiEmitter:
    ...
    def test_emit_basic_spec(self, tmp_path):
        ...
        from midicoder.emitters.core.cp20_api_client.react import ReactApiEmitter
...
class TestFastAPIApiEmitter:
    ...
    def test_emit_basic_spec(self):
        ...
        from midicoder.emitters.core.cp20_api_client.fastapi import FastAPIApiEmitter
...
class TestNestJSApiEmitter:
    ...
    def test_emit_basic_spec(self):
        ...
        from midicoder.emitters.core.cp20_api_client.nestjs import NestJSApiEmitter
