...
class TestSearchIndexColumnValidation:
    ...
    def test_empty_name_raises_error(self):
        ...
        assert exc_info.value.code == ErrorCode.CP10_EMPTY_INDEX_NAME
    ...
    def test_invalid_column_type_raises_error(self):
        ...
        assert exc_info.value.code == ErrorCode.CP10_INVALID_COLUMN_TYPE
...
class TestCP10ErrorCodes:
    ...
    def test_error_code_values(self):
        ...
        assert ErrorCode.CP10_EMPTY_INDEX_NAME.value == "MDC-CP10-001"
        assert ErrorCode.CP10_INVALID_PROVIDER.value == "MDC-CP10-002"
        assert ErrorCode.CP10_SYNC_STRATEGY_INVALID.value == "MDC-CP10-003"
        assert ErrorCode.CP10_INVALID_COLUMN_TYPE.value == "MDC-CP10-004"
        assert ErrorCode.CP10_INDEX_CREATE_FAILED.value == "MDC-CP10-005"
