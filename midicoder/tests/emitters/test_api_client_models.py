...
class TestTransportType:
    ...
    def test_transport_type_values(self):
        ...
        from midicoder.emitters.core.api_client.models import TransportType
...
class TestAuthMode:
    ...
    def test_auth_mode_values(self):
        ...
        from midicoder.emitters.core.api_client.models import AuthMode
...
class TestHttpMethod:
    ...
    def test_http_method_values(self):
        ...
        from midicoder.emitters.core.api_client.models import HttpMethod
...
class TestClientBinding:
    ...
    def test_client_binding_creation(self):
        ...
        from midicoder.emitters.core.api_client.models import ClientBinding, HttpMethod
    ...
    def test_client_binding_from_dict(self):
        ...
        from midicoder.emitters.core.api_client.models import ClientBinding
        data = {
...
class TestRealtimeBridgeSpec:
    ...
    def test_realtime_bridge_spec_websocket(self):
        ...
        from midicoder.emitters.core.api_client.models import RealtimeBridgeSpec, TransportType
    ...
    def test_realtime_bridge_spec_from_dict(self):
        ...
        from midicoder.emitters.core.api_client.models import RealtimeBridgeSpec
        data = {
            "name": "Products",
            "transport": "sse",
...
class TestApiSpec:
    ...
    def test_api_spec_creation(self):
        ...
        from midicoder.emitters.core.api_client.models import ApiSpec, AuthMode
        spec = ApiSpec(
            name="CommerceAPI",
