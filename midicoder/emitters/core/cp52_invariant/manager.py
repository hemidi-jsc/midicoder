...
from midicoder.emitters.core.cp52_invariant.business.checks import register_business_invariants
from midicoder.emitters.core.cp52_invariant.compliance.checks import register_compliance_invariants
...
class InvariantManager:
    ...
    def _check_entity_ref(self, graph: CapabilityGraph) -> list[InvariantResult]:
        ...
        from midicoder.emitters.core.cp52_invariant.business.checks import check_entity_reference_integrity
    ...
    def _check_mutation_txn(self, graph: CapabilityGraph) -> list[InvariantResult]:
        ...
        from midicoder.emitters.core.cp52_invariant.business.checks import check_mutation_transaction_scope
    ...
    def _check_query_readonly(self, graph: CapabilityGraph) -> list[InvariantResult]:
        ...
        from midicoder.emitters.core.cp52_invariant.business.checks import check_query_read_only
    ...
    def _check_event_consistency(self, graph: CapabilityGraph) -> list[InvariantResult]:
        ...
        from midicoder.emitters.core.cp52_invariant.business.checks import check_event_consistency
    ...
    def _check_state_transition(self, graph: CapabilityGraph) -> list[InvariantResult]:
        ...
        from midicoder.emitters.core.cp52_invariant.business.checks import check_state_machine_transition
    ...
    def _check_pii_encryption(self, graph: CapabilityGraph) -> list[InvariantResult]:
        ...
        from midicoder.emitters.core.cp52_invariant.compliance.checks import check_pii_encryption
    ...
    def _check_audit_trail(self, graph: CapabilityGraph) -> list[InvariantResult]:
        ...
        from midicoder.emitters.core.cp52_invariant.compliance.checks import check_audit_trail
    ...
    def _check_data_retention(self, graph: CapabilityGraph) -> list[InvariantResult]:
        ...
        from midicoder.emitters.core.cp52_invariant.compliance.checks import check_data_retention
    ...
    def _check_tenant_isolation(self, graph: CapabilityGraph) -> list[InvariantResult]:
        ...
        from midicoder.emitters.core.cp52_invariant.compliance.checks import check_tenant_isolation
    ...
    def _check_permission(self, graph: CapabilityGraph) -> list[InvariantResult]:
        ...
        from midicoder.emitters.core.cp52_invariant.compliance.checks import check_permission_check
    ...
    def _check_error_handler(self, graph: CapabilityGraph) -> list[InvariantResult]:
        ...
        from midicoder.emitters.core.cp52_invariant.failure_mode.checks import check_error_handler_present
    ...
    def _check_retry_policy(self, graph: CapabilityGraph) -> list[InvariantResult]:
        ...
        from midicoder.emitters.core.cp52_invariant.failure_mode.checks import check_retry_policy
    ...
    def _check_timeout(self, graph: CapabilityGraph) -> list[InvariantResult]:
        ...
        from midicoder.emitters.core.cp52_invariant.failure_mode.checks import check_timeout_configured
    ...
    def _check_circuit_breaker(self, graph: CapabilityGraph) -> list[InvariantResult]:
        ...
        from midicoder.emitters.core.cp52_invariant.failure_mode.checks import check_circuit_breaker
    ...
    def _check_compensation(self, graph: CapabilityGraph) -> list[InvariantResult]:
        ...
        from midicoder.emitters.core.cp52_invariant.failure_mode.checks import check_compensation_defined
