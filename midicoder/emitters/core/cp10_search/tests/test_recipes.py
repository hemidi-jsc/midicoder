...
from midicoder.emitters.core.cp10_search.recipes import (
    elasticsearch_recipe,
    meilisearch_recipe,
    opensearch_recipe,
    vector_search_recipe,
...
class TestVectorSearchRecipe:
    ...
    def test_returns_vector_search_index(self):
        from midicoder.emitters.core.cp10_search.models import VectorSearchIndex
...
class TestGeospatialSearchRecipe:
    ...
    def test_returns_geo_search_index(self):
        from midicoder.emitters.core.cp10_search.models import GeoSearchIndex
...
class TestFacetedSearchRecipe:
    ...
    def test_returns_faceted_search_index(self):
        from midicoder.emitters.core.cp10_search.models import FacetedSearchIndex
    ...
    def test_custom_facets_override(self):
        from midicoder.emitters.core.cp10_search.models import Facet
