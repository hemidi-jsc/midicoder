...
class TestCP10Pack(TestCase):
    ...
    def setUp(self):
        ...
        self.pack_path = Path("midicoder/emitters/core/cp10_search/pack.yml")
    ...
    def test_pack_yml_exists(self):
        """Pack.yml phai ton tai tai duong dan cp10_search."""
        self.assertTrue(
            self.pack_path.exists(),
            "Pack.yml khong ton tai tai midicoder/emitters/core/cp10_search/pack.yml",
        )
    ...
    def test_pack_internal_id(self):
        """Pack internal_id phai la cp10_search."""
        data = self._load_pack()
        self.assertEqual(data["pack"]["internal_id"], "cp10_search")
    ...
    def test_taxonomy_cp10_internal_id(self):
        """CP10 internal_id trong taxonomy phai la cp10_search."""
        cp10 = self._get_cp10_from_taxonomy()
        self.assertIsNotNone(cp10)
        self.assertEqual(cp10["internal_id"], "cp10_search")
