...
from midicoder.emitters.core.cp13_workflow_runtime.engine.saga_orchestrator import (
    SagaOrchestrator,
    SagaExecutionState,
    SagaStepResult,
    SagaStepStatus,
...
class TestSagaOrchestratorValidate:
    ...
    def test_empty_steps_raises_error(self):
        ...
        assert exc_info.value.code == ErrorCode.CP13_WORKFLOW_STATE_MACHINE_ERROR
    ...
    def test_step_without_action_raises_error(self):
        ...
        assert exc_info.value.code == ErrorCode.CP13_WORKFLOW_INVALID_TRANSITION
