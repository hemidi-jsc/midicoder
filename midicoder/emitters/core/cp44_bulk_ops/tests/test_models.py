...
class TestBulkJob:
    ...
    def test_from_dict_with_status(self):
        ...
        from midicoder.emitters.core.cp44_bulk_ops.models import BulkJob, JobStatus
        data = {
            "job_id": "job_status",
            "entity_type": "item",
            "action": "batch_update",
...
class TestBulkChunk:
    ...
    def test_chunk_to_dict_with_results(self):
        ...
        from midicoder.emitters.core.cp44_bulk_ops.models import BulkChunk, BulkResult
        chunk = BulkChunk(
            chunk_id="chunk_res",
            job_id="job_res",
            chunk_number=1,
...
class TestBulkEngine:
    ...
    def test_create_duplicate_job_raises_error(self):
        ...
        from midicoder.emitters.core.cp44_bulk_ops.models import BulkAction, BulkEngine
        engine = BulkEngine()
