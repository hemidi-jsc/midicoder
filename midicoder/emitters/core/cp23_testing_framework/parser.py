...
class TestParser:
    ...
    def parse(self, raw: str | dict[str, Any]) -> TestCollection:
        ...
        if isinstance(raw, str):
            ...
            try:
                ...
                EM.raise_error(
                    ErrorCode.CP23_DSL_PARSE_ERROR,
    ...
    def _parse_test_type(self, value: str) -> TestType:
        ...
        try:
            ...
            EM.raise_error(
                ErrorCode.CP23_INVALID_TEST_TYPE,
                test_type=value,
    ...
    def _parse_suite(self, data: dict[str, Any], default_name: str = "") -> TestSuite:
        ...
        try:
            ...
            EM.raise_error(
                ErrorCode.CP23_INVALID_FRAMEWORK,
    ...
    def _parse_assertion(self, data: dict[str, Any]) -> "TestAssertion":
        ...
        from midicoder.emitters.core.cp23_testing_framework.models import TestAssertion
        ...
        try:
            ...
            EM.raise_error(
                ErrorCode.CP23_INVALID_ASSERTION,
                check=check_str,
