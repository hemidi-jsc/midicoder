...
class TestChannelSpec:
    ...
    def test_empty_channel_id_raises(self):
        ...
        assert exc_info.value.code == ErrorCode.CP22_CHANNEL_NOT_FOUND
    ...
    def test_empty_event_topic_raises(self):
        ...
        assert exc_info.value.code == ErrorCode.CP22_EVENT_PARSE_FAILED
...
class TestPresenceState:
    ...
    def test_empty_user_id_raises(self):
        ...
        assert exc_info.value.code == ErrorCode.CP22_INVALID_WIDGET_TYPE
