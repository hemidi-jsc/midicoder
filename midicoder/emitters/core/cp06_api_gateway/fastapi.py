...
class FastAPIGatewayEmitter:
    ...
    Attributes:
        stack_dir: Directory chứa Jinja2 templates (stacks/fastapi/core/)
    """
    ...
    def _emit_infrastructure(self) -> dict[str, str]:
        ...
        infra_templates = [
            ("cp06_api_gateway/__init__.py.jinja2", "gateway/__init__.py"),
            ("cp06_api_gateway/circuit_breaker.py.jinja2", "gateway/circuit_breaker.py"),
            ("cp06_api_gateway/gateway_app.py.jinja2", "gateway/gateway_app.py"),
            ("cp06_api_gateway/gateway_router.py.jinja2", "gateway/gateway_router.py"),
            ("cp06_api_gateway/gateway_service.py.jinja2", "gateway/gateway_service.py"),
            ("cp06_api_gateway/rate_limiter.py.jinja2", "gateway/rate_limiter.py"),
            ("cp06_api_gateway/route_config.py.jinja2", "gateway/route_config.py"),
        ]
