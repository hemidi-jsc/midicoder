# Changelog — CP01 Domain Model DSL & IR Builder
...
**Capabilities Provided:** `dsl_parsing`, `projection_tree_build`, `ir_build`

**Capabilities (Runtime):** `entity_modeling`, `command_query_separation`, `value_object`
