# coding: utf-8
"""
FastAPI Emitter cho CP61: Distributed Tracing & Correlation ID.

Module này render Jinja2 templates để sinh distributed tracing code
cho FastAPI stack, bao gồm tracing config, correlation middleware,
span decorators, và log correlation setup.
...
class FastAPITracingEmitter:
    """Emitter cho FastAPI stack — CP61 Distributed Tracing & Correlation ID.

    Render templates từ `stacks/fastapi/core/cp61_distributed_tracing/`
    ...
    def emit(
        ...
        """Emit distributed tracing code cho FastAPI.
        ...
        templates = [
            ("tracing_config.py.jinja2", "app/config/tracing_config.py"),
            ("correlation_middleware.py.jinja2", "app/middleware/correlation_middleware.py"),
            ("span_decorators.py.jinja2", "app/utils/span_decorators.py"),
            ("log_correlation.py.jinja2", "app/utils/log_correlation.py"),
            ("tracing_integration.py.jinja2", "app/integrations/tracing_integration.py"),
        ]
