...
class NestJSPaymentEmitter:
    """Emitter cho NestJS stack — CP45 Payment Gateway Abstraction.

    Render templates từ `stacks/nestjs/core/cp45_payment/`
    ...
    def emit(
        ...
        """Emit payment gateway code cho NestJS.
        ...
        templates = [
            ("payment.entity.ts.jinja2", "src/payment/entities/payment.entity.ts"),
            ("payment.dto.ts.jinja2", "src/payment/dtos/payment.dto.ts"),
            ("payment.service.ts.jinja2", "src/payment/services/payment.service.ts"),
            ("payment.controller.ts.jinja2", "src/payment/controllers/payment.controller.ts"),
            ("payment-webhook.controller.ts.jinja2", "src/payment/controllers/payment-webhook.controller.ts"),
            ("payment.module.ts.jinja2", "src/payment/payment.module.ts"),
        ]
