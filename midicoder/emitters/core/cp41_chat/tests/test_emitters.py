...
# stack_dir = .../stacks/{stack}/core  (emitter tự thêm /cp41_chat)
...
def _make_ir():
    ...
    from midicoder.emitters.core.cp41_chat.recipes import basic_chat_recipe
...
class TestFastAPIChatEmitter:
    ...
    def test_init_raises_error_when_template_dir_not_found(self):
        ...
        from midicoder.emitters.core.cp41_chat.fastapi import FastAPIChatEmitter
    ...
    def test_init_sets_template_dir_correctly(self):
        ...
        emitter = FastAPIChatEmitter(stack_dir=str(FASTAPI_STACK_DIR))
        assert emitter.template_dir == FASTAPI_STACK_DIR / "cp41_chat"
    ...
    def test_emit_with_redis_context(self, tmp_path: Path):
        ...
        from midicoder.emitters.core.cp41_chat.fastapi import FastAPIChatEmitter
        from midicoder.emitters.core.cp41_chat.recipes import full_messaging_recipe
...
class TestNestJSChatEmitter:
    ...
    def test_init_raises_error_when_template_dir_not_found(self):
        """Kiểm tra __init__ raise MidicoderError khi template dir không tìm thấy."""
        from midicoder.emitters.core.cp41_chat.nestjs import NestJSChatEmitter
    ...
    def test_init_sets_template_dir_correctly(self):
        ...
        emitter = NestJSChatEmitter(stack_dir=str(NESTJS_STACK_DIR))
        assert emitter.template_dir == NESTJS_STACK_DIR / "cp41_chat"
...
class TestAngularChatEmitter:
    ...
    def test_init_raises_error_when_template_dir_not_found(self):
        """Kiểm tra __init__ raise MidicoderError khi template dir không tìm thấy."""
        from midicoder.emitters.core.cp41_chat.angular import AngularChatEmitter
...
class TestReactChatEmitter:
    ...
    def test_init_raises_error_when_template_dir_not_found(self):
        """Kiểm tra __init__ raise MidicoderError khi template dir không tìm thấy."""
        from midicoder.emitters.core.cp41_chat.react import ReactChatEmitter
