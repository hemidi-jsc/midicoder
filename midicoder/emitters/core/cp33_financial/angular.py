...
class FinancialAngularEmitter:
    ...
    Render templates từ `stacks/angular/core/cp33_financial/`
    ...
    def __init__(self, stack_dir: str | Path) -> None:
        ...
        self.template_dir = self.stack_dir / "cp33_financial"
    ...
    def _render(self, template_name: str, context: dict[str, Any]) -> str:
        ...
        try:
            ...
            raise EM.raise_error(
                ErrorCode.CP33_TEMPLATE_NOT_FOUND,
                template=template_name,
                reason=f"Jinja2 template not found: {template_name}",
            )
        except Exception as e:
            raise EM.raise_error(
                ErrorCode.CP33_RENDER_FAILED,
                template=template_name,
