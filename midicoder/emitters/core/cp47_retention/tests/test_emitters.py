...
from midicoder.emitters.core.cp47_retention.parser import parse_to_ir, RetentionIR
...
class TestFastAPIEmitter:
    @pytest.fixture
    def emitter(self):
        from midicoder.emitters.core.cp47_retention.fastapi import FastAPIRetentionEmitter
...
class TestNestJSEmitter:
    @pytest.fixture
    def emitter(self):
        from midicoder.emitters.core.cp47_retention.nestjs import NestJSRetentionEmitter
        stacks_dir = PACKAGE_DIR / "stacks"
...
class TestAngularEmitter:
    @pytest.fixture
    def emitter(self):
        from midicoder.emitters.core.cp47_retention.angular import AngularRetentionEmitter
        stacks_dir = PACKAGE_DIR / "stacks"
...
class TestReactEmitter:
    @pytest.fixture
    def emitter(self):
        from midicoder.emitters.core.cp47_retention.react import ReactRetentionEmitter
        stacks_dir = PACKAGE_DIR / "stacks"
...
class TestPackManifest:
    ...
    def test_pack_internal_id(self):
        with open(PACK_DIR / "pack.yml", encoding="utf-8") as f:
            data = yaml.safe_load(f)
        assert data["pack"]["internal_id"] == "cp47_retention"
...
class TestStackTemplates:
    ...
    def _check_templates(self, stack_dir_name, expected_count):
        stacks_dir = PACKAGE_DIR / "stacks"
        template_dir = stacks_dir / stack_dir_name / "core" / "cp47_retention"
...
class TestRegistry:
    def test_cp47_in_registry(self):
        ...
        assert CP_ID_TO_INTERNAL["CP47"] == "cp47_retention"
...
class TestInitModule:
    ...
    def test_init_exports_models(self):
        from midicoder.emitters.core.cp47_retention import (
            RetentionEngine,
            RetentionPolicy,
            ArchivedRecord,
            ErasureRequest,
