...
class TestParseApprovalRequests:
    ...
    def test_parse_from_approval_requests_key(self):
        ...
        from midicoder.emitters.core.cp42_approval.parser import parse_approval_requests
        data = {
            "approval_requests": [
                {
                    "request_id": "req_001",
...
class TestParseApprovalSteps:
    ...
    def test_parse_from_approval_steps_key(self):
        ...
        from midicoder.emitters.core.cp42_approval.parser import parse_approval_steps
        data = {
            "approval_steps": [
                {
                    "step_id": "step_001",
...
class TestParseEscalationRules:
    ...
    def test_parse_from_escalation_rules_key(self):
        ...
        from midicoder.emitters.core.cp42_approval.parser import parse_escalation_rules
        data = {
            "escalation_rules": [
                {
                    "rule_id": "rule_001",
...
class TestParseDelegations:
    ...
    def test_parse_from_delegations_key(self):
        ...
        from midicoder.emitters.core.cp42_approval.parser import parse_delegations
        data = {
            "delegations": [
                {
                    "delegation_id": "del_001",
...
class TestParseToIR:
    ...
    def test_parse_full_data_to_ir(self):
        ...
        from midicoder.emitters.core.cp42_approval.parser import parse_to_ir
        data = {
            "approval_requests": [
                {
                    "request_id": "req_ir",
