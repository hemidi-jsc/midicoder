...
from midicoder.emitters.core.cp09_cache.angular import AngularEmitter, emit_angular_cache
from midicoder.emitters.core.cp09_cache.react import ReactEmitter, emit_react_cache
...
def run_e2e():
    ...
    try:
        ...
        assert CP_ID_TO_INTERNAL["CP09"] == "cp09_cache", f"Wrong mapping: {CP_ID_TO_INTERNAL['CP09']}"
        results.append(("Pack registry", True, "CP09 → cp09_cache registered"))
        passed += 1
    ...
    try:
        ...
        pack = data["pack"]
        assert pack["id"] == "CP09"
        assert pack["internal_id"] == "cp09_cache"
    ...
    try:
        ...
        fc = loader.load(pack_internal_id="cp09_cache", pack_id="CP09", stack="fastapi")
    ...
    try:
        ...
        required_templates = {
            "fastapi": ["cp09_cache/redis.py.jinja2", "cp09_cache/cache_decorators.py.jinja2",
                        "cp09_cache/cache_invalidate.py.jinja2", "cp09_cache/cache_strategy.py.jinja2",
                        "cp09_cache/cdn_cache.py.jinja2", "cp09_cache/stampede_prevention.py.jinja2",
                        "cp09_cache/cache_warmup.py.jinja2"],
            "nestjs": ["cp09_cache/redis.module.ts.jinja2", "cp09_cache/cache.interceptor.ts.jinja2",
                        "cp09_cache/cdn_cache.ts.jinja2", "cp09_cache/stampede_prevention.ts.jinja2",
                        "cp09_cache/cache_warmup.ts.jinja2", "cp09_cache/multi_tier.ts.jinja2"],
            "angular": ["cp09_cache/cache.module.ts.jinja2", "cp09_cache/cache.service.ts.jinja2",
                        "cp09_cache/cache.interceptor.ts.jinja2"],
            "react": ["cp09_cache/CacheProvider.tsx.jinja2", "cp09_cache/useCache.ts.jinja2",
                      "cp09_cache/cache-utils.ts.jinja2"],
        }
        missing = []
