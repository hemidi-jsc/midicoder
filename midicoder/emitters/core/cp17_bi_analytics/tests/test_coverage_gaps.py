...
from midicoder.emitters.core.cp17_bi_analytics.models import ReportFrequency, ScheduledReport
...
class TestReportSchedulerOncePolicy:
    ...
    def test_update_next_run_once_sets_far_future(self):
        ...
        from midicoder.emitters.core.cp17_bi_analytics.models import SchedulePolicy
