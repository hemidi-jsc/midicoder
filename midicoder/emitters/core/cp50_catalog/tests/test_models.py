...
class TestCP50ErrorCodes:
    ...
    def test_cp50_product_not_found(self):
        assert ErrorCode.CP50_PRODUCT_NOT_FOUND == "MDC-CP50-001"

    def test_cp50_category_not_found(self):
        assert ErrorCode.CP50_CATEGORY_NOT_FOUND == "MDC-CP50-002"

    def test_cp50_variant_not_found(self):
        assert ErrorCode.CP50_VARIANT_NOT_FOUND == "MDC-CP50-003"

    def test_cp50_attribute_not_found(self):
        assert ErrorCode.CP50_ATTRIBUTE_NOT_FOUND == "MDC-CP50-004"

    def test_cp50_duplicate_sku(self):
        assert ErrorCode.CP50_DUPLICATE_SKU == "MDC-CP50-005"

    def test_cp50_invalid_product_status(self):
        assert ErrorCode.CP50_INVALID_PRODUCT_STATUS == "MDC-CP50-006"

    def test_cp50_category_cycle_detected(self):
        assert ErrorCode.CP50_CATEGORY_CYCLE_DETECTED == "MDC-CP50-007"

    def test_cp50_attribute_type_invalid(self):
        assert ErrorCode.CP50_ATTRIBUTE_TYPE_INVALID == "MDC-CP50-008"

    def test_cp50_category_depth_exceeded(self):
        assert ErrorCode.CP50_CATEGORY_DEPTH_EXCEEDED == "MDC-CP50-009"

    def test_cp50_search_index_not_ready(self):
        assert ErrorCode.CP50_SEARCH_INDEX_NOT_READY == "MDC-CP50-010"
...
class TestProductStatus:
    ...
    def test_status_draft_value(self):
        from midicoder.emitters.core.cp50_catalog.models import ProductStatus
...
class TestAttributeType:
    ...
    def test_type_string_value(self):
        from midicoder.emitters.core.cp50_catalog.models import AttributeType
...
class TestSortOrder:
    ...
    def test_order_asc_value(self):
        from midicoder.emitters.core.cp50_catalog.models import SortOrder
...
class TestVisibility:
    ...
    def test_visibility_public_value(self):
        from midicoder.emitters.core.cp50_catalog.models import Visibility
...
class TestCategoryLevel:
    ...
    def test_level_root_value(self):
        from midicoder.emitters.core.cp50_catalog.models import CategoryLevel
...
class TestProduct:
    ...
    def test_create_valid_product(self):
        ...
        from midicoder.emitters.core.cp50_catalog.models import (
            Product,
            ProductStatus,
        )
        product = Product(
    ...
    def test_create_product_empty_product_id_raises(self):
        ...
        from midicoder.emitters.core.cp50_catalog.models import Product
...
class TestCategory:
    ...
    def test_create_valid_category(self):
        ...
        from midicoder.emitters.core.cp50_catalog.models import Category
        cat = Category(
            category_id="cat_001",
            name="Điện tử",
...
class TestProductVariant:
    ...
    def test_create_valid_variant(self):
        ...
        from midicoder.emitters.core.cp50_catalog.models import ProductVariant
...
class TestAttributeDefinition:
    ...
    def test_create_attribute_empty_attribute_id_raises(self):
        ...
        from midicoder.emitters.core.cp50_catalog.models import AttributeDefinition
        with pytest.raises(MidicoderError):
            AttributeDefinition(
                attribute_id="",
...
class TestAttributeValue:
    ...
    def test_create_valid_attribute_value(self):
        ...
        from midicoder.emitters.core.cp50_catalog.models import AttributeValue
        av = AttributeValue(
...
class TestCatalogEngine:
    ...
    def _create_engine(self) -> "CatalogEngine":
        ...
        from midicoder.emitters.core.cp50_catalog.models import CatalogEngine
