...
class TestSchemaEvolutionEnums:
    ...
    def test_schema_format_avro(self):
        from midicoder.emitters.core.cp38_data_etl.models import SchemaFormat
    ...
    def test_compatibility_mode_backward(self):
        from midicoder.emitters.core.cp38_data_etl.models import CompatibilityMode
...
class TestSchemaRegistryConfig:
    ...
    def test_schema_registry_config_with_auth(self):
        from midicoder.emitters.core.cp38_data_etl.models import SchemaRegistryConfig
...
class TestSchemaEvolutionRule:
    ...
    def test_schema_evolution_rule_creation(self):
        from midicoder.emitters.core.cp38_data_etl.models import SchemaEvolutionRule
