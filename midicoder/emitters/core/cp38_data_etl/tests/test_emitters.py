...
# tests/ is at: midicoder/emitters/core/cp38_data_etl/tests/
...
class TestFastAPIETLEmitter:
    ...
    def test_init_raises_error_when_template_dir_not_found(self):
        from midicoder.emitters.core.cp38_data_etl.fastapi import FastAPIETLEmitter
...
class TestNestJSETLEmitter:
    ...
    def test_init_raises_error_when_template_dir_not_found(self):
        from midicoder.emitters.core.cp38_data_etl.nestjs import NestJSETLEmitter
...
class TestAngularETLEmitter:
    ...
    def test_init_raises_error_when_template_dir_not_found(self):
        from midicoder.emitters.core.cp38_data_etl.angular import AngularETLEmitter
...
class TestReactETLEmitter:
    ...
    def test_init_raises_error_when_template_dir_not_found(self):
        from midicoder.emitters.core.cp38_data_etl.react import ReactETLEmitter
