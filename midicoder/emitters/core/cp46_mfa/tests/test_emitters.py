...
from midicoder.emitters.core.cp46_mfa.parser import MFAIR, MFARule
...
class TestFastAPIMFAEmitter:
    ...
    def setup(self):
        ...
        from midicoder.emitters.core.cp46_mfa.fastapi import FastAPIMFAEmitter
...
class TestNestJSMFAEmitter:
    ...
    def setup(self):
        ...
        from midicoder.emitters.core.cp46_mfa.nestjs import NestJSMFAEmitter
...
class TestAngularMFAEmitter:
    ...
    def setup(self):
        ...
        from midicoder.emitters.core.cp46_mfa.angular import AngularMFAEmitter
...
class TestReactMFAEmitter:
    ...
    def setup(self):
        ...
        from midicoder.emitters.core.cp46_mfa.react import ReactMFAEmitter
