...
Templates: stacks/angular/cp_frontend_auth_ui/**/*.jinja2
...
_TEMPLATE_DIR = _PACKAGE_DIR / "stacks" / "angular" / "core" / "cp_frontend_auth_ui"
...
class AngularAuthUIEmitter:
    ...
    def __init__(self, ui_framework: str = "material") -> None:
        ...
        if ui_framework not in self.SUPPORTED_UI_FRAMEWORKS:
            EM.raise_error(
                ErrorCode.MDC-FE01_INVALID_UI_FRAMEWORK,
    ...
    def _render_template(self, template_name: str, context: dict[str, Any]) -> str:
        ...
        try:
            ...
            EM.raise_error(
                ErrorCode.MDC-FE01_TEMPLATE_NOT_FOUND,
                message=f"Template không tìm thấy: {template_name}",
                template_name=template_name,
            )
        except Exception as e:
            EM.raise_error(
                ErrorCode.MDC-FE01_RENDER_FAILED,
    ...
    def _write_file(
        ...
        return GeneratedFile(
            path=rel_path,
            content=content,
            template=f"angular/cp_frontend_auth_ui/{template_name}",
        )
    ...
    def _emit_index(self, output_dir: Path, root_dir: Path) -> GeneratedFile:
        ...
        try:
            ...
            rel_path = file_path
        return GeneratedFile(path=rel_path, content=content, template="angular/cp_frontend_auth_ui/index.ts")
