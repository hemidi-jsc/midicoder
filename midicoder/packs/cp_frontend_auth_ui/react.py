...
Templates: stacks/react/cp_frontend_auth_ui/**/*.jinja2
...
_TEMPLATE_DIR = _PACKAGE_DIR / "stacks" / "react" / "core" / "cp_frontend_auth_ui"
...
class ReactAuthUIEmitter:
    ...
    def _write_file(
        ...
        return GeneratedFile(
            path=rel_path,
            content=content,
            template=f"react/cp_frontend_auth_ui/{template_name}",
        )
    ...
    def _emit_index(self, output_dir: Path, root_dir: Path) -> GeneratedFile:
        ...
        try:
            ...
            rel_path = file_path
        return GeneratedFile(path=rel_path, content=content, template="react/cp_frontend_auth_ui/index.ts")
