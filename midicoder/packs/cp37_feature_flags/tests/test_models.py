...
class TestCP37Enums:
    ...
    def test_flag_variant_type_boolean(self):
        from midicoder.packs.cp37_feature_flags.models import FlagVariantType
    ...
    def test_condition_type_role(self):
        from midicoder.packs.cp37_feature_flags.models import ConditionType
    ...
    def test_config_value_type_string(self):
        from midicoder.packs.cp37_feature_flags.models import ConfigValueType
...
class TestFeatureFlag:
    ...
    def test_flag_empty_key_raises_error(self):
        from midicoder.packs.cp37_feature_flags.models import FeatureFlag
...
class TestTargetingRule:
    ...
    def test_rule_from_dict(self):
        from midicoder.packs.cp37_feature_flags.models import TargetingRule
...
class TestFlagEvaluation:
    ...
    def test_evaluation_auto_timestamp(self):
        from midicoder.packs.cp37_feature_flags.models import FlagEvaluation
...
class TestFeatureFlagEvaluator:
    ...
    def test_evaluate_flag_not_found(self):
        from midicoder.packs.cp37_feature_flags.models import FeatureFlagEvaluator
...
class TestABVariant:
    ...
    def test_variant_creation(self):
        from midicoder.packs.cp37_feature_flags.models import ABVariant
...
class TestABExperiment:
    ...
    def test_experiment_to_dict_from_dict(self):
        from midicoder.packs.cp37_feature_flags.models import ABExperiment, ABVariant
...
class TestABExperimentAssignment:
    ...
    def test_assignment_auto_timestamp(self):
        from midicoder.packs.cp37_feature_flags.models import ABExperimentAssignment
...
class TestABExperimentEngine:
    ...
    def test_assign_experiment_not_found_raises_error(self):
        from midicoder.packs.cp37_feature_flags.models import ABExperimentEngine
...
class TestConfigChange:
    ...
    def test_config_change_auto_timestamp(self):
        from midicoder.packs.cp37_feature_flags.models import ConfigChange
...
class TestDynamicConfig:
    ...
    def test_config_creation(self):
        from midicoder.packs.cp37_feature_flags.models import DynamicConfig
...
class TestFlagStore:
    ...
    def test_flag_store_is_abstract(self):
        from midicoder.packs.cp37_feature_flags.models import FlagStore
