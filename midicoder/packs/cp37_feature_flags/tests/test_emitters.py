...
# tests/ is at: midicoder/packs/cp37_feature_flags/tests/
# 4 parents up = midicoder/ (which contains both packs/ and stacks/)
PROJECT_ROOT = Path(__file__).parent.parent.parent.parent
FASTAPI_TEMPLATE_DIR = PROJECT_ROOT / "stacks" / "fastapi" / "cp37_feature_flags"
NESTJS_TEMPLATE_DIR = PROJECT_ROOT / "stacks" / "nestjs" / "cp37_feature_flags"
ANGULAR_TEMPLATE_DIR = PROJECT_ROOT / "stacks" / "angular" / "cp37_feature_flags"
REACT_TEMPLATE_DIR = PROJECT_ROOT / "stacks" / "react" / "cp37_feature_flags"
...
class TestFastAPIFeatureFlagEmitter:
    ...
    def test_init_raises_error_when_template_dir_not_found(self):
        from midicoder.packs.cp37_feature_flags.fastapi import (
...
class TestNestJSFeatureFlagEmitter:
    ...
    def test_init_raises_error_when_template_dir_not_found(self):
        from midicoder.packs.cp37_feature_flags.nestjs import (
...
class TestAngularFeatureFlagEmitter:
    ...
    def test_init_raises_error_when_template_dir_not_found(self):
        from midicoder.packs.cp37_feature_flags.angular import (
...
class TestReactFeatureFlagEmitter:
    ...
    def test_init_raises_error_when_template_dir_not_found(self):
        from midicoder.packs.cp37_feature_flags.react import (
