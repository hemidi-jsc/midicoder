...
class TestFastAPIBulkOpsEmitter:
    ...
    def test_emit_returns_files(self, tmp_path):
        ...
        from midicoder.packs.cp_full_bulk_etl.fastapi import FastAPIBulkOpsEmitter, GeneratedFile

        # Tạo template dir và mock templates
        template_dir = tmp_path / "cp_full_bulk_etl"
        template_dir.mkdir()
        for name in [
    ...
    def test_emit_template_count(self, tmp_path):
        ...
        from midicoder.packs.cp_full_bulk_etl.fastapi import FastAPIBulkOpsEmitter
...
class TestNestJSBulkOpsEmitter:
    ...
    def test_emit_returns_files(self, tmp_path):
        """Emitter trả về danh sách files."""
        from midicoder.packs.cp_full_bulk_etl.nestjs import NestJSBulkOpsEmitter
...
class TestAngularBulkOpsEmitter:
    ...
    def test_emit_returns_files(self, tmp_path):
        """Emitter trả về danh sách files."""
        from midicoder.packs.cp_full_bulk_etl.angular import AngularBulkOpsEmitter
...
class TestReactBulkOpsEmitter:
    ...
    def test_emit_returns_files(self, tmp_path):
        """Emitter trả về danh sách files."""
        from midicoder.packs.cp_full_bulk_etl.react import ReactBulkOpsEmitter
