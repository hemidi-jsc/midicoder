...
from midicoder.packs.cp36_tenant_onboarding.fastapi import (
    TenantOnboardingFastAPIEmitter,
    GeneratedFile,
)
from midicoder.packs.cp36_tenant_onboarding.nestjs import (
    TenantOnboardingNestJSEmitter,
)
from midicoder.packs.cp36_tenant_onboarding.react import (
    TenantOnboardingReactEmitter,
)
from midicoder.packs.cp36_tenant_onboarding.angular import (
    TenantOnboardingAngularEmitter,
)
from midicoder.packs.cp36_tenant_onboarding.recipes import (
