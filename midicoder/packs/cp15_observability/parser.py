...
class ObservabilityParser:
    ...
    def _parse_otel_exporter(self, data: dict[str, Any]):
        ...
        from midicoder.packs.cp15_observability.models import OTelExporterConfig, OTLPExportProtocol
    ...
    def _parse_sampler_type(self, value: str):
        ...
        from midicoder.packs.cp15_observability.models import SamplerType
    ...
    def _parse_log_destination(self, data: dict[str, Any]):
        ...
        from midicoder.packs.cp15_observability.models import LogDestinationType, LogShippingDestination
