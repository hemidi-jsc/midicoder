...
# File lives at: .../midicoder/packs/cp15_observability/tests/test_observability_templates.py
...
EXPECTED_TEMPLATES = [
    # FastAPI (2 templates)
    "midicoder/stacks/fastapi/cp15_observability/observability_service.py.jinja2",
    "midicoder/stacks/fastapi/cp15_observability/observability_middleware.py.jinja2",
    # NestJS (3 templates)
    "midicoder/stacks/nestjs/cp15_observability/observability.module.ts.jinja2",
    "midicoder/stacks/nestjs/cp15_observability/observability.service.ts.jinja2",
    "midicoder/stacks/nestjs/cp15_observability/observability.interceptor.ts.jinja2",
    # Angular (2 templates)
    "midicoder/stacks/angular/cp15_observability/logging_service.ts.jinja2",
    "midicoder/stacks/angular/cp15_observability/log_viewer.component.ts.jinja2",
    # React (3 templates)
    "midicoder/stacks/react/cp15_observability/types.ts.jinja2",
    "midicoder/stacks/react/cp15_observability/useLogging.ts.jinja2",
    "midicoder/stacks/react/cp15_observability/LogViewer.tsx.jinja2",
]
...
class TestTemplateContent:
    ...
    def test_fastapi_service_has_observability_class(self):
        ...
        content = self._read_template("midicoder/stacks/fastapi/cp15_observability/observability_service.py.jinja2")
    ...
    def test_fastapi_middleware_has_middleware_class(self):
        ...
        content = self._read_template("midicoder/stacks/fastapi/cp15_observability/observability_middleware.py.jinja2")
    ...
    def test_nestjs_module_has_module_decorator(self):
        ...
        content = self._read_template("midicoder/stacks/nestjs/cp15_observability/observability.module.ts.jinja2")
    ...
    def test_nestjs_service_has_injectable(self):
        ...
        content = self._read_template("midicoder/stacks/nestjs/cp15_observability/observability.service.ts.jinja2")
    ...
    def test_nestjs_interceptor_has_interceptor(self):
        ...
        content = self._read_template("midicoder/stacks/nestjs/cp15_observability/observability.interceptor.ts.jinja2")
    ...
    def test_angular_logging_service_has_injectable(self):
        ...
        content = self._read_template("midicoder/stacks/angular/cp15_observability/logging_service.ts.jinja2")
        assert "@Injectable" in content, "Thiếu @Injectable decorator"
    ...
    def test_angular_log_viewer_has_component(self):
        ...
        content = self._read_template("midicoder/stacks/angular/cp15_observability/log_viewer.component.ts.jinja2")
...
class TestEmittersGenerateCorrectFiles:
    ...
    def test_fastapi_emitter_files(self):
        ...
        from midicoder.packs.cp15_observability.fastapi import FastAPIObservabilityEmitter
    ...
    def test_nestjs_emitter_files(self):
        ...
        from midicoder.packs.cp15_observability.nestjs import NestJSObservabilityEmitter
    ...
    def test_angular_emitter_files(self):
        ...
        from midicoder.packs.cp15_observability.angular import AngularObservabilityEmitter
    ...
    def test_react_emitter_files(self):
        ...
        from midicoder.packs.cp15_observability.react import ReactObservabilityEmitter
