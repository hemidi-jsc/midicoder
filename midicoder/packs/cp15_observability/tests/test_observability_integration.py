...
# File lives at: .../midicoder/packs/cp15_observability/tests/
...
"""
    ...
    def test_parse_to_structured_logger(self):
        ...
        from midicoder.packs.cp15_observability.parser import ObservabilityParser
        from midicoder.packs.cp15_observability.logging import StructuredLogger
...
"""
    ...
    def test_parse_to_trace_context(self):
        ...
        from midicoder.packs.cp15_observability.parser import ObservabilityParser
        from midicoder.packs.cp15_observability.tracing import TraceContext
...
class TestLogImmutabilityObligation:
    ...
    def test_log_entry_hash_detected_tampering(self):
        ...
        from midicoder.packs.cp15_observability.logging import StructuredLogger, LogEntry
...
class TestInitExports:
    ...
    def test_all_models_exported(self):
        ...
        from midicoder.packs.cp15_observability import (
    ...
    def test_all_list_complete(self):
        ...
        from midicoder.packs.cp15_observability import __all__
        expected = {
            "MetricType", "LogLevel", "TracePropagationFormat",
            "MetricProfile", "StructuredLogConfig", "TraceConfig",
            "ObservabilityParser",
