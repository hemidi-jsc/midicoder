...
class TestFrontendApp:
    ...
    def test_frontend_app_empty_name_raises(self):
        ...
        with pytest.raises(MidicoderError) as exc_info:
            FrontendApp(name="")
        assert exc_info.value.code == ErrorCode.MDC-F04_EMPTY_APP_NAME
    ...
    def test_frontend_app_invalid_ui_framework_raises(self):
        ...
        assert exc_info.value.code == ErrorCode.MDC-F04_INVALID_UI_FRAMEWORK
...
class TestRouteDefinition:
    ...
    def test_route_definition_empty_path_raises(self):
        ...
        assert exc_info.value.code == ErrorCode.MDC-F04_INVALID_ROUTE_PATH
    ...
    def test_route_definition_empty_component_raises(self):
        ...
        assert exc_info.value.code == ErrorCode.MDC-F04_EMPTY_ROUTE_COMPONENT
    ...
    def test_duplicate_routes_detection(self):
        ...
        assert exc_info.value.code == ErrorCode.MDC-F04_DUPLICATE_ROUTE
...
class TestStateStoreConfig:
    ...
    def test_state_store_config_invalid_type_raises(self):
        ...
        assert exc_info.value.code == ErrorCode.MDC-F04_INVALID_STATE_STORE
