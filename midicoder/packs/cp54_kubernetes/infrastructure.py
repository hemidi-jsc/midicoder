# coding: utf-8
"""
Infrastructure Emitter cho CP54: Kubernetes & Cloud Native Deployment.
...
class K8sInfrastructureEmitter:
    ...
    Render templates từ `stacks/infrastructure/cp54_kubernetes/`
    ...
    def __init__(self, stack_dir: str | Path) -> None:
        ...
        self.template_dir = self.stack_dir / "cp54_kubernetes"
