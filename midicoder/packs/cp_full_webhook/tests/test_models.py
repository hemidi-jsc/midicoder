...
class TestCP40ErrorCodes:
    ...
    def test_cp40_subscription_not_found_code(self):
        assert ErrorCode.MDC-F17_WEBHOOK_SUBSCRIPTION_NOT_FOUND == "MDC-CP40-001"

    def test_cp40_duplicate_subscription_code(self):
        assert ErrorCode.MDC-F17_WEBHOOK_DUPLICATE_SUBSCRIPTION == "MDC-CP40-002"

    def test_cp40_dispatch_failed_code(self):
        assert ErrorCode.MDC-F17_WEBHOOK_DISPATCH_FAILED == "MDC-CP40-003"

    def test_cp40_invalid_url_code(self):
        assert ErrorCode.MDC-F17_WEBHOOK_INVALID_URL == "MDC-CP40-004"

    def test_cp40_auth_config_invalid_code(self):
        assert ErrorCode.MDC-F17_WEBHOOK_AUTH_CONFIG_INVALID == "MDC-CP40-005"
...
class TestWebhookStatus:
    ...
    def test_status_active_value(self):
        from midicoder.packs.cp_full_webhook.models import WebhookStatus
...
class TestWebhookSubscription:
    ...
    def test_create_valid_subscription(self):
        from midicoder.packs.cp_full_webhook.models import WebhookSubscription
...
class TestWebhookDispatch:
    ...
    def test_dispatch_auto_timestamp(self):
        from midicoder.packs.cp_full_webhook.models import WebhookDispatch
        d = WebhookDispatch(
            dispatch_id="disp_001",
            subscription_id="wh_001",
            event_type="order.created",
...
class TestWebhookDeliveryAttempt:
    ...
    def test_create_attempt(self):
        from midicoder.packs.cp_full_webhook.models import WebhookDeliveryAttempt
...
class TestRetryPolicy:
    ...
    def test_get_delay_attempt_zero_equals_base(self):
        from midicoder.packs.cp_full_webhook.models import RetryPolicy
...
class TestWebhookDispatcher:
    ...
    def _make_subscription(self, sid: str, etype: str, url: str = "https://example.com/hook",
        ...
        from midicoder.packs.cp_full_webhook.models import WebhookSubscription, WebhookStatus
    ...
    def test_add_subscription(self):
        from midicoder.packs.cp_full_webhook.models import WebhookDispatcher, WebhookSubscription, WebhookStatus
    ...
    def test_remove_nonexistent_subscription(self):
        from midicoder.packs.cp_full_webhook.models import WebhookDispatcher
        dispatcher = WebhookDispatcher()
    ...
    def test_get_subscriptions_by_event_filters_inactive(self):
        from midicoder.packs.cp_full_webhook.models import WebhookDispatcher, WebhookStatus
        dispatcher = WebhookDispatcher()
        dispatcher.add_subscription(self._make_subscription("wh_001", "order.created"))
