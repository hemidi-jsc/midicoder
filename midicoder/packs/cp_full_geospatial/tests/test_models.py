...
class TestGeoPoint:
    ...
    def test_invalid_latitude_too_high_raises_error(self):
        ...
        assert exc_info.value.code == ErrorCode.MDC-F23_INVALID_LATITUDE
    ...
    def test_invalid_longitude_too_high_raises_error(self):
        ...
        assert exc_info.value.code == ErrorCode.MDC-F23_INVALID_LONGITUDE
...
class TestGeofence:
    ...
    def test_polygon_too_few_points_raises_error(self):
        ...
        assert exc_info.value.code == ErrorCode.MDC-F23_GEOFENCE_TOO_FEW_POINTS
    ...
    def test_empty_name_raises_error(self):
        ...
        assert exc_info.value.code == ErrorCode.MDC-F23_GEOSPEC_INVALID
    ...
    def test_zero_radius_raises_error(self):
        ...
        assert exc_info.value.code == ErrorCode.MDC-F23_GEOFENCE_EMPTY_RADIUS
