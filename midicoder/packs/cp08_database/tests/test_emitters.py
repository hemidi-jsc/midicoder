...
from midicoder.packs.cp08_database.fastapi import SQLAlchemyEmitter
from midicoder.packs.cp08_database.nestjs import TypeORMEmitter
...
class TestSQLAlchemyEmitter:
    ...
    def test_emit_connection_config_with_replicas(self):
        ds = Datasource(
            ...
            read_replicas=[__import__("midicoder.packs.cp08_database.models", fromlist=["ReplicaConfig"]).ReplicaConfig(
