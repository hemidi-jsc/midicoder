...
class TestCP45ErrorCodes:
    ...
    def test_payment_gateway_not_found_code(self):
        assert ErrorCode.MDC-F26_PAYMENT_GATEWAY_NOT_FOUND.value == "MDC-CP45-001"

    def test_payment_method_not_found_code(self):
        assert ErrorCode.MDC-F26_PAYMENT_METHOD_NOT_FOUND.value == "MDC-CP45-002"

    def test_payment_processing_failed_code(self):
        assert ErrorCode.MDC-F26_PAYMENT_PROCESSING_FAILED.value == "MDC-CP45-003"

    def test_invalid_payment_amount_code(self):
        assert ErrorCode.MDC-F26_INVALID_PAYMENT_AMOUNT.value == "MDC-CP45-004"

    def test_payment_idempotency_conflict_code(self):
        assert ErrorCode.MDC-F26_PAYMENT_IDEMPOTENCY_CONFLICT.value == "MDC-CP45-005"

    def test_refund_amount_exceeds_original_code(self):
        assert ErrorCode.MDC-F26_REFUND_AMOUNT_EXCEEDS_ORIGINAL.value == "MDC-CP45-006"

    def test_refund_not_allowed_code(self):
        assert ErrorCode.MDC-F26_REFUND_NOT_ALLOWED.value == "MDC-CP45-007"

    def test_webhook_signature_invalid_code(self):
        assert ErrorCode.MDC-F26_WEBHOOK_SIGNATURE_INVALID.value == "MDC-CP45-008"

    def test_payment_gateway_timeout_code(self):
        assert ErrorCode.MDC-F26_PAYMENT_GATEWAY_TIMEOUT.value == "MDC-CP45-009"

    def test_payment_method_expired_code(self):
        assert ErrorCode.MDC-F26_PAYMENT_METHOD_EXPIRED.value == "MDC-CP45-010"
