...
class TestPackYAML:
    def test_pack_yml_exists(self):
        pack_path = Path("midicoder/packs/cp05_event_driven/pack.yml")
...
class TestInitExports:
    def test_import_all_models(self):
        from midicoder.packs.cp05_event_driven import (
            CQRSProjection,
            DeliveryGuarantee,
            DLQConfig,
            DLQPolicy,
    ...
    def test_import_parser(self):
        from midicoder.packs.cp05_event_driven import EventParser
    ...
    def test_all_exports_defined(self):
        import midicoder.packs.cp05_event_driven as cp05
