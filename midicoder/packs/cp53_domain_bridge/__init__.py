...
Sử dụng:
    from midicoder.packs.domain_bridge import (
...
from midicoder.packs.domain_bridge.fastapi import FastAPIDomainBridgeEmitter
from midicoder.packs.domain_bridge.nestjs import NestJSDomainBridgeEmitter
