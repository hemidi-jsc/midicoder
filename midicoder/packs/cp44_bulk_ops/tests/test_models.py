...
class TestBulkAction:
    ...
    def test_action_batch_create_value(self):
        ...
        from midicoder.packs.cp44_bulk_ops.models import BulkAction
...
class TestJobStatus:
    ...
    def test_status_pending_value(self):
        ...
        from midicoder.packs.cp44_bulk_ops.models import JobStatus
...
class TestChunkStatus:
    ...
    def test_status_pending_value(self):
        """Kiểm tra giá trị PENDING."""
        from midicoder.packs.cp44_bulk_ops.models import ChunkStatus
...
class TestRetryStrategy:
    ...
    def test_strategy_exponential_backoff_value(self):
        ...
        from midicoder.packs.cp44_bulk_ops.models import RetryStrategy
...
class TestBulkJob:
    ...
    def test_create_job_empty_id_raises_error(self):
        ...
        from midicoder.packs.cp44_bulk_ops.models import BulkAction, BulkJob
    ...
    def test_from_dict_with_status(self):
        ...
        from midicoder.packs.cp44_bulk_ops.models import BulkJob, JobStatus
        data = {
            "job_id": "job_status",
            "entity_type": "item",
            "action": "batch_update",
...
class TestBulkChunk:
    ...
    def test_create_valid_chunk_with_all_fields(self):
        ...
        from midicoder.packs.cp44_bulk_ops.models import BulkChunk, ChunkStatus
        chunk = BulkChunk(
            chunk_id="chunk_001",
            job_id="job_001",
            chunk_number=1,
    ...
    def test_create_chunk_minimal(self):
        ...
        from midicoder.packs.cp44_bulk_ops.models import BulkChunk
        chunk = BulkChunk(
            chunk_id="chunk_min",
            job_id="job_min",
            chunk_number=1,
    ...
    def test_chunk_to_dict_with_results(self):
        ...
        from midicoder.packs.cp44_bulk_ops.models import BulkChunk, BulkResult
        chunk = BulkChunk(
            chunk_id="chunk_res",
            job_id="job_res",
            chunk_number=1,
...
class TestBulkResult:
    ...
    def test_create_success_result(self):
        ...
        from midicoder.packs.cp44_bulk_ops.models import BulkResult
...
class TestDLQEntry:
    ...
    def test_create_valid_dlq_entry(self):
        ...
        from midicoder.packs.cp44_bulk_ops.models import DLQEntry
        entry = DLQEntry(
            entry_id="dlq_001",
            job_id="job_001",
            entity_id="e1",
...
class TestBulkEngine:
    ...
    def test_create_engine(self):
        ...
        from midicoder.packs.cp44_bulk_ops.models import BulkEngine
        engine = BulkEngine()
    ...
    def test_create_duplicate_job_raises_error(self):
        ...
        from midicoder.packs.cp44_bulk_ops.models import BulkAction, BulkEngine
        engine = BulkEngine()
