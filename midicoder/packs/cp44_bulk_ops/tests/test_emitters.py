...
class TestFastAPIBulkOpsEmitter:
    ...
    def test_emit_returns_files(self, tmp_path):
        ...
        from midicoder.packs.cp44_bulk_ops.fastapi import FastAPIBulkOpsEmitter, GeneratedFile
    ...
    def test_emit_template_count(self, tmp_path):
        ...
        from midicoder.packs.cp44_bulk_ops.fastapi import FastAPIBulkOpsEmitter
...
class TestNestJSBulkOpsEmitter:
    ...
    def test_emit_returns_files(self, tmp_path):
        """Emitter trả về danh sách files."""
        from midicoder.packs.cp44_bulk_ops.nestjs import NestJSBulkOpsEmitter
...
class TestAngularBulkOpsEmitter:
    ...
    def test_emit_returns_files(self, tmp_path):
        """Emitter trả về danh sách files."""
        from midicoder.packs.cp44_bulk_ops.angular import AngularBulkOpsEmitter
...
class TestReactBulkOpsEmitter:
    ...
    def test_emit_returns_files(self, tmp_path):
        """Emitter trả về danh sách files."""
        from midicoder.packs.cp44_bulk_ops.react import ReactBulkOpsEmitter
