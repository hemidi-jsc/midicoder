# coding: utf-8
"""
NestJS Emitter cho CP46: MFA & Advanced Authentication.

Module này render Jinja2 templates để sinh MFA code
cho NestJS stack, bao gồm controller, service, module, DTO, entity,
và WebAuthn guard.
...
class NestJSMFAEmitter:
    """Emitter cho NestJS stack — CP46 MFA & Advanced Authentication.

    Render templates từ `stacks/nestjs/cp46_mfa/`
    để sinh MFA code.
    """
    ...
    def emit(
        ...
        templates = [
            ("mfa.controller.ts.jinja2", "src/mfa/mfa.controller.ts"),
            ("mfa.service.ts.jinja2", "src/mfa/mfa.service.ts"),
            ("mfa.module.ts.jinja2", "src/mfa/mfa.module.ts"),
            ("mfa.dto.ts.jinja2", "src/mfa/dto/mfa.dto.ts"),
            ("mfa.entity.ts.jinja2", "src/mfa/entities/mfa.entity.ts"),
            ("mfa.guard.ts.jinja2", "src/mfa/guards/mfa.guard.ts"),
        ]
