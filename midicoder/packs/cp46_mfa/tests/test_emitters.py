...
from midicoder.packs.cp46_mfa.parser import MFAIR, MFARule
from midicoder.packs.cp46_mfa.models import MFAMethod, MFAPriority
...
class TestFastAPIMFAEmitter:
    ...
    def setup(self):
        ...
        self.template_dir = root / "stacks" / "fastapi" / "core" / "cp46_mfa"
        from midicoder.packs.cp46_mfa.fastapi import FastAPIMFAEmitter
...
class TestNestJSMFAEmitter:
    ...
    def setup(self):
        import os
        root = Path(__file__).resolve().parent.parent.parent.parent.parent
        self.template_dir = root / "stacks" / "nestjs" / "core" / "cp46_mfa"
        from midicoder.packs.cp46_mfa.nestjs import NestJSMFAEmitter
...
class TestAngularMFAEmitter:
    ...
    def setup(self):
        import os
        root = Path(__file__).resolve().parent.parent.parent.parent.parent
        self.template_dir = root / "stacks" / "angular" / "core" / "cp46_mfa"
        from midicoder.packs.cp46_mfa.angular import AngularMFAEmitter
...
class TestReactMFAEmitter:
    ...
    def setup(self):
        import os
        root = Path(__file__).resolve().parent.parent.parent.parent.parent
        self.template_dir = root / "stacks" / "react" / "core" / "cp46_mfa"
        from midicoder.packs.cp46_mfa.react import ReactMFAEmitter
...
class TestEmitterIntegration:
    def test_ir_data_flows_through_emitter(self):
        root = Path(__file__).resolve().parent.parent.parent.parent.parent
        template_dir = root / "stacks" / "fastapi" / "core" / "cp46_mfa"
        from midicoder.packs.cp46_mfa.fastapi import FastAPIMFAEmitter
