# coding: utf-8
"""
React Emitter cho CP46: MFA & Advanced Authentication.

Module này render Jinja2 templates để sinh MFA code
cho React stack, bao gồm components, hooks, types, và forms.
...
class ReactMFAEmitter:
    """Emitter cho React stack — CP46 MFA & Advanced Authentication.

    Render templates từ `stacks/react/cp46_mfa/`
    để sinh MFA code.
    """
    ...
    def emit(
        ...
        templates = [
            ("MFASetup.tsx.jinja2", "src/components/mfa/MFASetup.tsx"),
            ("MFAVerify.tsx.jinja2", "src/components/mfa/MFAVerify.tsx"),
            ("MFAMethods.tsx.jinja2", "src/components/mfa/MFAMethods.tsx"),
            ("useMFA.ts.jinja2", "src/hooks/mfa/useMFA.ts"),
            ("mfa-types.ts.jinja2", "src/types/mfa-types.ts"),
            ("mfa-api.ts.jinja2", "src/api/mfa-api.ts"),
        ]
