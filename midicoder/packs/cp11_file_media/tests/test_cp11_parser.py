...
class TestFileStorageParser:
    ...
    def test_parse_yaml_string(self):
        ...
        from midicoder.packs.cp11_file_media.models import StorageBackend, TransformType
...
"""
    ...
    def test_parse_from_metadata(self):
        ...
        from midicoder.packs.cp11_file_media.parser import FileStorageParser
        from midicoder.packs.cp11_file_media.models import StorageBackend
    ...
    def test_parse_invalid_yaml_raises_error(self):
        ...
        assert exc_info.value.code == ErrorCode.CP11_DSL_PARSE_ERROR
