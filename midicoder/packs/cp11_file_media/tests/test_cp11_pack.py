...
# Pack is at: midicoder/packs/cp11_file_media/
# This test is at: midicoder/packs/cp11_file_media/tests/
...
class TestPackEmittersExist:
    ...
    def test_angular_emitter_exists(self):
        from midicoder.packs.cp11_file_media.angular import AngularFileStorageEmitter
        assert AngularFileStorageEmitter

    def test_react_emitter_exists(self):
        from midicoder.packs.cp11_file_media.react import ReactFileStorageEmitter
