...
class TestFastApiS3Config(TestCase):
    ...
    def setUp(self):
        self.template_path = Path("midicoder/stacks/fastapi/cp11_file_media/s3.py.jinja2")
...
class TestFastApiFileUpload(TestCase):
    ...
    def setUp(self):
        self.template_path = Path("midicoder/stacks/fastapi/cp11_file_media/file_upload.py.jinja2")
...
class TestNestJsS3Module(TestCase):
    ...
    def setUp(self):
        self.template_path = Path("midicoder/stacks/nestjs/cp11_file_media/s3.module.ts.jinja2")
...
class TestNestJsFileUpload(TestCase):
    ...
    def setUp(self):
        self.template_path = Path("midicoder/stacks/nestjs/cp11_file_media/file-upload.service.ts.jinja2")
