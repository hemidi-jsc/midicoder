...
class TestStorageProfile:
    ...
    def test_create_valid_s3_profile(self):
        ...
        from midicoder.packs.cp11_file_media.models import StorageProfile, StorageBackend
    ...
    def test_invalid_backend_type_raises_error(self):
        ...
        from midicoder.packs.cp11_file_media.models import StorageProfile
...
class TestUploadPolicy:
    ...
    def test_create_valid_policy(self):
        ...
        from midicoder.packs.cp11_file_media.models import UploadPolicy
...
class TestMediaTransform:
    ...
    def test_create_valid_resize(self):
        ...
        from midicoder.packs.cp11_file_media.models import MediaTransform, TransformType
    ...
    def test_invalid_transform_type_raises_error(self):
        ...
        from midicoder.packs.cp11_file_media.models import MediaTransform
...
class TestFileStorageCollection:
    ...
    def test_get_by_id_not_found(self):
        ...
        from midicoder.packs.cp11_file_media.models import FileStorageCollection
