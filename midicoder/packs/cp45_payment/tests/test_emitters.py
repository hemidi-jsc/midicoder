...
from midicoder.packs.cp45_payment.parser import parse_to_ir, PaymentIR
...
class TestFastAPIEmitter:
    @pytest.fixture
    def emitter(self):
        from midicoder.packs.cp45_payment.fastapi import FastAPIPaymentEmitter
...
class TestNestJSEmitter:
    @pytest.fixture
    def emitter(self):
        from midicoder.packs.cp45_payment.nestjs import NestJSPaymentEmitter
        stacks_dir = PACKAGE_DIR / "stacks"
...
class TestAngularEmitter:
    @pytest.fixture
    def emitter(self):
        from midicoder.packs.cp45_payment.angular import AngularPaymentEmitter
        stacks_dir = PACKAGE_DIR / "stacks"
...
class TestReactEmitter:
    @pytest.fixture
    def emitter(self):
        from midicoder.packs.cp45_payment.react import ReactPaymentEmitter
        stacks_dir = PACKAGE_DIR / "stacks"
...
class TestInitModule:
    ...
    def test_init_exports_models(self):
        from midicoder.packs.cp45_payment import (
            PaymentEngine,
            PaymentTransaction,
            PaymentMethod,
            PaymentRefund,
