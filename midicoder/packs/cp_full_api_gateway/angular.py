...
class AngularGatewayEmitter:
    ...
    Attributes:
        stack_dir: Directory chứa Jinja2 templates (stacks/angular/)
    """
    ...
    def _emit_infrastructure(self, collection: RouteCollection) -> dict[str, str]:
        ...
        infra_templates = [
            ("cp_full_api_gateway/gateway.module.ts.jinja2", "app/core/gateway/gateway.module.ts"),
            ("cp_full_api_gateway/api-client.service.ts.jinja2", "app/core/gateway/api-client.service.ts"),
            ("cp_full_api_gateway/route-guard.service.ts.jinja2", "app/core/gateway/route-guard.service.ts"),
        ]
