...
class NestJSGatewayEmitter:
    ...
    def _emit_infrastructure(self) -> dict[str, str]:
        ...
        infra_templates = [
            ("cp_full_api_gateway/gateway.module.ts.jinja2", "gateway/gateway.module.ts"),
            ("cp_full_api_gateway/gateway.service.ts.jinja2", "gateway/gateway.service.ts"),
            ("cp_full_api_gateway/gateway.controller.ts.jinja2", "gateway/gateway.controller.ts"),
            ("cp_full_api_gateway/circuit-breaker.providers.ts.jinja2", "gateway/circuit-breaker.providers.ts"),
            ("cp_full_api_gateway/rate-limiter.providers.ts.jinja2", "gateway/rate-limiter.providers.ts"),
            ("cp_full_api_gateway/route-config.service.ts.jinja2", "gateway/route-config.service.ts"),
        ]
