...
class ReactGatewayEmitter:
    ...
    Attributes:
        stack_dir: Directory chứa Jinja2 templates (stacks/react/)
    """
    ...
    def _emit_infrastructure(self, collection: RouteCollection) -> dict[str, str]:
        ...
        infra_templates = [
            ("cp_full_api_gateway/api-client.ts.jinja2", "gateway/api-client.ts"),
            ("cp_full_api_gateway/route-guard.tsx.jinja2", "gateway/route-guard.tsx"),
            ("cp_full_api_gateway/types.ts.jinja2", "gateway/types.ts"),
        ]
