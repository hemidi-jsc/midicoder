...
FASTAPI_STACK_DIR = MIDICODER_ROOT / "midicoder" / "stacks" / "fastapi" / "core" / "cp_full_approval"
NESTJS_STACK_DIR = MIDICODER_ROOT / "midicoder" / "stacks" / "nestjs" / "core" / "cp_full_approval"
ANGULAR_STACK_DIR = MIDICODER_ROOT / "midicoder" / "stacks" / "angular" / "core" / "cp_full_approval"
REACT_STACK_DIR = MIDICODER_ROOT / "midicoder" / "stacks" / "react" / "core" / "cp_full_approval"


def _make_ir():
    """Tạo ApprovalIR sample cho testing từ basic_approval_recipe."""
    from midicoder.packs.cp_full_approval.recipes import basic_approval_recipe
