...
"""
    ...
    def test_parse_invalid_yaml_raises_error(self):
        ...
        assert exc_info.value.code == ErrorCode.MDC-F18_DSL_PARSE_ERROR
...
"""
    ...
    def test_parse_with_invalid_severity_raises_error(self):
        ...
        assert exc_info.value.code == ErrorCode.MDC-F18_INVALID_SEVERITY
    ...
    def test_parse_with_invalid_category_raises_error(self):
        ...
        assert exc_info.value.code == ErrorCode.MDC-F18_INVALID_CATEGORY
    ...
    def test_parse_with_invalid_prompt_category_raises_error(self):
        ...
        assert exc_info.value.code == ErrorCode.MDC-F18_INVALID_PROMPT_CATEGORY
