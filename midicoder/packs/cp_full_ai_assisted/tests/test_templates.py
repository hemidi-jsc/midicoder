...
from midicoder.packs.cp_full_ai_assisted.parser import AIAssistantParser
from midicoder.packs.cp_full_ai_assisted.recipes import auto_generate_ai_assistant_from_mir
...
STACK_DIRS = {
    "fastapi": ROOT / "midicoder" / "stacks" / "fastapi" / "core" / "cp_full_ai_assisted",
    "nestjs": ROOT / "midicoder" / "stacks" / "nestjs" / "core" / "cp_full_ai_assisted",
    "angular": ROOT / "midicoder" / "stacks" / "angular" / "core" / "cp_full_ai_assisted",
    "react": ROOT / "midicoder" / "stacks" / "react" / "core" / "cp_full_ai_assisted",
}
