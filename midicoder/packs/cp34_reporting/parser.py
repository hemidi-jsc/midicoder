...
class ReportParser:
    ...
    def parse_from_metadata(self, data: dict[str, Any]) -> ReportCollection:
        ...
        """
        if not isinstance(data, dict):
            EM.raise_error(ErrorCode.CP34_PARSER_ERROR, message="Report metadata phải là dict")
    ...
    def _parse_report_spec(self, data: dict[str, Any]) -> ReportSpec:
        ...
        """
        if not isinstance(data, dict):
            EM.raise_error(ErrorCode.CP34_PARSER_ERROR, message="Report spec phải là YAML mapping")
