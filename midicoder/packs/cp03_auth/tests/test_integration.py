...
from midicoder.packs.cp03_auth.fastapi import FastAPIAuthEmitter
from midicoder.packs.cp03_auth.nestjs import NestJSEmitter
from midicoder.packs.cp03_auth.angular import AngularEmitter
from midicoder.packs.cp03_auth.react import ReactEmitter
...
class TestAuthIntegration:
    ...
    def test_pack_self_contained(self):
        ...
        import importlib
        auth_module = importlib.import_module("midicoder.packs.cp03_auth")
        models = importlib.import_module("midicoder.packs.cp03_auth.models")
        parser = importlib.import_module("midicoder.packs.cp03_auth.parser")
