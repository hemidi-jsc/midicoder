...
class TestFastApiElasticsearchConfig(TestCase):
    ...
    def setUp(self):
        ...
        self.template_path = Path(
            "midicoder/stacks/fastapi/cp_full_search/elasticsearch.py.jinja2"
        )
...
class TestFastApiSearchService(TestCase):
    ...
    def setUp(self):
        """Thiet lap test fixtures."""
        self.template_path = Path(
            "midicoder/stacks/fastapi/cp_full_search/search_service.py.jinja2"
        )
...
class TestFastApiIndexManager(TestCase):
    ...
    def setUp(self):
        """Thiet lap test fixtures."""
        self.template_path = Path(
            "midicoder/stacks/fastapi/cp_full_search/index_manager.py.jinja2"
        )
...
class TestNestJsSearchModule(TestCase):
    ...
    def setUp(self):
        """Thiet lap test fixtures."""
        self.template_path = Path(
            "midicoder/stacks/nestjs/cp_full_search/search.module.ts.jinja2"
        )
...
class TestNestJsSearchService(TestCase):
    ...
    def setUp(self):
        """Thiet lap test fixtures."""
        self.template_path = Path(
            "midicoder/stacks/nestjs/cp_full_search/search.service.ts.jinja2"
        )
...
class TestNestJsSearchDecorators(TestCase):
    ...
    def setUp(self):
        """Thiet lap test fixtures."""
        self.template_path = Path(
            "midicoder/stacks/nestjs/cp_full_search/search.decorators.ts.jinja2"
        )
...
class TestAngularSearchService(TestCase):
    ...
    def setUp(self):
        """Thiet lap test fixtures."""
        self.template_path = Path(
            "midicoder/stacks/angular/cp_full_search/search.service.ts.jinja2"
        )
...
class TestAngularSearchModule(TestCase):
    ...
    def setUp(self):
        """Thiet lap test fixtures."""
        self.template_path = Path(
            "midicoder/stacks/angular/cp_full_search/search.module.ts.jinja2"
        )
...
class TestReactSearchProvider(TestCase):
    ...
    def setUp(self):
        """Thiet lap test fixtures."""
        self.template_path = Path(
            "midicoder/stacks/react/cp_full_search/SearchProvider.tsx.jinja2"
        )
...
class TestReactUseSearch(TestCase):
    ...
    def setUp(self):
        """Thiet lap test fixtures."""
        self.template_path = Path(
            "midicoder/stacks/react/cp_full_search/useSearch.ts.jinja2"
        )
