...
class TestCP49ErrorCodes:
    ...
    def test_cp_full_consent_record_not_found_code(self):
        assert ErrorCode.MDC-F31_CONSENT_RECORD_NOT_FOUND == "MDC-CP49-001"

    def test_cp_full_consent_purpose_invalid_code(self):
        assert ErrorCode.MDC-F31_CONSENT_PURPOSE_INVALID == "MDC-CP49-002"

    def test_cp_full_consent_category_invalid_code(self):
        assert ErrorCode.MDC-F31_CONSENT_CATEGORY_INVALID == "MDC-CP49-003"

    def test_cp49_mandatory_consent_cannot_revoke_code(self):
        assert ErrorCode.MDC-F31_MANDATORY_CONSENT_CANNOT_REVOKE == "MDC-CP49-004"

    def test_cp49_comm_channel_invalid_code(self):
        assert ErrorCode.MDC-F31_COMM_CHANNEL_INVALID == "MDC-CP49-005"

    def test_cp49_tenant_policy_not_found_code(self):
        assert ErrorCode.MDC-F31_TENANT_POLICY_NOT_FOUND == "MDC-CP49-006"

    def test_cp49_cookie_category_invalid_code(self):
        assert ErrorCode.MDC-F31_COOKIE_CATEGORY_INVALID == "MDC-CP49-007"

    def test_cp_full_consent_expired_need_renew_code(self):
        assert ErrorCode.MDC-F31_CONSENT_EXPIRED_NEED_RENEW == "MDC-CP49-008"
...
class TestConsentStatus:
    ...
    def test_status_active_value(self):
        from midicoder.packs.cp_full_consent.models import ConsentStatus
...
class TestConsentPurpose:
    ...
    def test_purpose_analytics_value(self):
        from midicoder.packs.cp_full_consent.models import ConsentPurpose
...
class TestConsentCategory:
    ...
    def test_category_necessary_value(self):
        from midicoder.packs.cp_full_consent.models import ConsentCategory
...
class TestCookieCategory:
    ...
    def test_cookie_necessary_value(self):
        from midicoder.packs.cp_full_consent.models import CookieCategory
...
class TestCommChannel:
    ...
    def test_channel_email_value(self):
        from midicoder.packs.cp_full_consent.models import CommChannel
...
class TestCookiePreference:
    ...
    def test_create_valid_preference(self):
        from midicoder.packs.cp_full_consent.models import CookiePreference
...
class TestConsentEngine:
    ...
    def test_engine_empty_collections_on_init(self):
        ...
        from midicoder.packs.cp_full_consent.models import ConsentEngine
