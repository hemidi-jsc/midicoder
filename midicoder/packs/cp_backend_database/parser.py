...
class DBParser:
    ...
    def parse(self, raw: str) -> DataModelCollection:
        ...
        try:
            ...
            EM.raise_error(ErrorCode.MDC-BE01_DSL_PARSE_ERROR, original_error=str(e))

        if not isinstance(data, dict):
            EM.raise_error(ErrorCode.MDC-BE01_DSL_PARSE_ERROR, reason="YAML root phai la mapping")
