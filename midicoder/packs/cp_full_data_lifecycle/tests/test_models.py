...
class TestCP47ErrorCodes:
    ...
    def test_retention_policy_not_found_code(self):
        assert ErrorCode.MDC-F29_RETENTION_POLICY_NOT_FOUND.value == "MDC-CP47-001"

    def test_retention_days_invalid_code(self):
        assert ErrorCode.MDC-F29_RETENTION_DAYS_INVALID.value == "MDC-CP47-002"

    def test_archive_failed_code(self):
        assert ErrorCode.MDC-F29_ARCHIVE_FAILED.value == "MDC-CP47-003"

    def test_purge_not_allowed_code(self):
        assert ErrorCode.MDC-F29_PURGE_NOT_ALLOWED.value == "MDC-CP47-004"

    def test_erasure_request_not_found_code(self):
        assert ErrorCode.MDC-F29_ERASURE_REQUEST_NOT_FOUND.value == "MDC-CP47-005"

    def test_erasure_in_progress_code(self):
        assert ErrorCode.MDC-F29_ERASURE_IN_PROGRESS.value == "MDC-CP47-006"

    def test_cold_storage_unavailable_code(self):
        assert ErrorCode.MDC-F29_COLD_STORAGE_UNAVAILABLE.value == "MDC-CP47-007"

    def test_retention_scan_failed_code(self):
        assert ErrorCode.MDC-F29_RETENTION_SCAN_FAILED.value == "MDC-CP47-008"

    def test_exemption_already_exists_code(self):
        assert ErrorCode.MDC-F29_EXEMPTION_ALREADY_EXISTS.value == "MDC-CP47-009"

    def test_restore_failed_code(self):
        assert ErrorCode.MDC-F29_RESTORE_FAILED.value == "MDC-CP47-010"
