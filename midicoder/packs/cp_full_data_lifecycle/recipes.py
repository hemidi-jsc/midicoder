...
# ===========================================================================
# CP65: Data Backup & Recovery — Recipes (merged)
# ===========================================================================
...
@dataclass
class BackupRecipeOutput:
    """Kết quả từ backup recipe builder.
    ...
    def to_dict(self) -> dict[str, Any]:
        """Chuyển BackupRecipeOutput sang dict."""
        return {
            "name": self.name,
            "description": self.description,
            "ir": self.ir.to_dict(),
...
def database_backup_recipe() -> BackupRecipeOutput:
    ...
    Returns:
        BackupRecipeOutput chứa BackupIR
    """
    data = {
        "backup_policies": [
            {
    ...
    ir = parse_backup_to_ir(data)

    return BackupRecipeOutput(
...
def disaster_recovery_recipe() -> BackupRecipeOutput:
...
def compliance_backup_recipe() -> BackupRecipeOutput:
