...
class TestParseLocales:
    ...
    def test_parse_locales_primary_key(self):
        from midicoder.packs.cp39_i18n_runtime.parser import parse_locales
...
class TestParseTranslations:
    ...
    def test_parse_translations_primary_key(self):
        from midicoder.packs.cp39_i18n_runtime.parser import parse_translations
...
class TestParseCacheConfig:
    ...
    def test_parse_cache_config_primary(self):
        from midicoder.packs.cp39_i18n_runtime.parser import parse_cache_config
...
class TestParseToIR:
    ...
    def test_parse_to_ir_full(self):
        from midicoder.packs.cp39_i18n_runtime.parser import parse_to_ir
...
class TestI18nRuntimeIR:
    ...
    def test_ir_to_dict(self):
        ...
        from midicoder.packs.cp39_i18n_runtime.models import LocaleConfig, TranslationEntry, CacheConfig
