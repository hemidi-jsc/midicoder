...
from midicoder.packs.cp39_i18n_runtime.recipes import RecipeOutput
...
class TestBasicI18nRecipe:
    ...
    def test_returns_recipe_output(self):
        from midicoder.packs.cp39_i18n_runtime.recipes import basic_i18n_recipe
...
class TestMultitenantI18nRecipe:
    ...
    def test_returns_recipe_output(self):
        from midicoder.packs.cp39_i18n_runtime.recipes import multitenant_i18n_recipe
