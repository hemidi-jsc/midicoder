...
class TestReadReceiptType:
    ...
    def test_delivered_value(self):
        ...
        from midicoder.packs.cp_full_chat.models import ReadReceiptType
...
class TestConversation:
    ...
    def test_create_valid_conversation(self):
        ...
        from midicoder.packs.cp_full_chat.models import Conversation, ConversationType
        conv = Conversation(
    ...
    def test_create_conversation_with_empty_id_raises(self):
        ...
        from midicoder.packs.cp_full_chat.models import Conversation
...
class TestChatMessage:
    ...
    def test_create_valid_message(self):
        ...
        from midicoder.packs.cp_full_chat.models import ChatMessage
        msg = ChatMessage(
            message_id="msg_001",
            conversation_id="conv_001",
            sender_id="user_1",
    ...
    def test_create_message_with_too_long_content_raises(self):
        ...
        from midicoder.packs.cp_full_chat.models import ChatMessage, ChatManager
        long_content = "x" * 4097
        msg = ChatMessage(
            message_id="msg_long",
            conversation_id="conv_001",
    ...
    def test_message_with_image_type(self):
        ...
        from midicoder.packs.cp_full_chat.models import ChatMessage, MessageType
        msg = ChatMessage(
            message_id="msg_img",
            conversation_id="conv_001",
            sender_id="user_1",
    ...
    def test_message_status_default_sent(self):
        ...
        from midicoder.packs.cp_full_chat.models import ChatMessage, MessageStatus
        msg = ChatMessage(
...
class TestConversationParticipant:
    ...
    def test_create_valid_participant(self):
        ...
        from midicoder.packs.cp_full_chat.models import ConversationParticipant
...
class TestReadReceipt:
    ...
    def test_create_valid_receipt(self):
        ...
        from midicoder.packs.cp_full_chat.models import ReadReceipt, ReadReceiptType
        r = ReadReceipt(
    ...
    def test_receipt_auto_timestamp(self):
        ...
        from midicoder.packs.cp_full_chat.models import ReadReceipt
        r = ReadReceipt(
...
class TestNotification:
    ...
    def test_create_valid_notification(self):
        ...
        from midicoder.packs.cp_full_chat.models import Notification, NotificationType
        n = Notification(
    ...
    def test_notification_auto_timestamp(self):
        ...
        from midicoder.packs.cp_full_chat.models import Notification
        n = Notification(
...
class TestChatManager:
    ...
    def test_add_conversation(self):
        ...
        from midicoder.packs.cp_full_chat.models import ChatManager, Conversation
        manager = ChatManager()
    ...
    def test_add_participant_to_nonexistent_conversation_raises(self):
        ...
        from midicoder.packs.cp_full_chat.models import ChatManager, ConversationParticipant
        manager = ChatManager()
        p = ConversationParticipant(
    ...
    def test_get_unread_notifications(self):
        ...
        manager = self._setup_manager_with_conv_and_participant()
        from midicoder.packs.cp_full_chat.models import ConversationParticipant, Notification
    ...
    def test_send_message_creates_notification(self):
        ...
        manager = self._setup_manager_with_conv_and_participant()
        from midicoder.packs.cp_full_chat.models import ChatMessage, ConversationParticipant, NotificationType
        # Thêm người tham gia thứ 2
        p2 = ConversationParticipant(
            participant_id="part_u2",
            conversation_id="conv_001",
