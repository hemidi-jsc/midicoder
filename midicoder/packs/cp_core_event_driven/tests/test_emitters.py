...
from midicoder.packs.cp_core_event_driven.fastapi import (
    FastAPIEventEmitter,
    GeneratedFile as FastAPIGeneratedFile,
)
from midicoder.packs.cp_core_event_driven.models import EventDefinition
from midicoder.packs.cp_core_event_driven.nestjs import (
    NestJSEventEmitter,
...
class TestTemplateContent:
    def test_fastapi_templates_exist(self):
        base = Path("midicoder/stacks/fastapi/cp_core_event_driven")
    ...
    def test_nestjs_templates_exist(self):
        base = Path("midicoder/stacks/nestjs/cp_core_event_driven")
