...
class TestDashboardProfile:
    ...
    def test_empty_name_raises_error(self):
        ...
        assert exc_info.value.code == ErrorCode.MDC-F15_EMPTY_DASHBOARD_NAME
...
class TestAlertRule:
    ...
    def test_evaluation_interval_less_than_5_raises_error(self):
        ...
        assert exc_info.value.code == ErrorCode.MDC-F15_ALERT_EVALUATION_INTERVAL_INVALID
...
class TestSLIDefinition:
    ...
    def test_empty_name_raises_error(self):
        ...
        assert exc_info.value.code == ErrorCode.MDC-F15_EMPTY_SLI_NAME
    ...
    def test_zero_target_raises_error(self):
        ...
        assert exc_info.value.code == ErrorCode.MDC-F15_INVALID_SLI_TARGET
