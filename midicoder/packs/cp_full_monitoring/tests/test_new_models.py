...
class TestHealthCheck:
    ...
    def test_empty_name_raises_error(self):
        with pytest.raises(MidicoderError) as exc_info:
            HealthCheck(name="")
        assert exc_info.value.code == ErrorCode.MDC-F15_EMPTY_HEALTH_CHECK_NAME
    ...
    def test_invalid_path_raises_error(self):
        ...
        assert exc_info.value.code == ErrorCode.MDC-F15_INVALID_HEALTH_CHECK_PATH
...
class TestNotificationChannel:
    ...
    def test_empty_name_raises_error(self):
        ...
        assert exc_info.value.code == ErrorCode.MDC-F15_EMPTY_ALERT_NAME
...
class TestEscalationPolicy:
    ...
    def test_empty_name_raises_error(self):
        ...
        assert exc_info.value.code == ErrorCode.MDC-F15_EMPTY_ESCALATION_NAME
...
class TestSLOTracking:
    ...
    def test_empty_name_raises_error(self):
        ...
        assert exc_info.value.code == ErrorCode.MDC-F15_EMPTY_SLO_NAME
    ...
    def test_zero_target_raises_error(self):
        ...
        assert exc_info.value.code == ErrorCode.MDC-F15_INVALID_SLO_TARGET
