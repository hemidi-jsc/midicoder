# coding: utf-8
"""
Mô-đun report scheduler runtime engine (CP17 — merged into cp_full_monitoring).
...
from midicoder.packs.cp_full_monitoring.models import ScheduledReport, ReportFormat
...
class ReportScheduler:
    ...
    def _update_next_run(self, report: ScheduledReport) -> None:
        ...
        """
        from midicoder.packs.cp_full_monitoring.models import SchedulePolicy
