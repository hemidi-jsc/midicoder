...
class MonitoringParser:
    ...
    def _parse_alert_rule(self, data: dict[str, Any]) -> AlertRule:
        ...
        try:
            ...
            EM.raise_error(
                ErrorCode.MDC-F15_INVALID_ALERT_CONDITION,
        ...
        try:
            ...
            EM.raise_error(
                ErrorCode.MDC-F15_INVALID_ALERT_SEVERITY,
    ...
    def _parse_sli_definition(self, data: dict[str, Any]) -> SLIDefinition:
        ...
        try:
            ...
            EM.raise_error(
                ErrorCode.MDC-F15_INVALID_SLI_METRIC_TYPE,
    ...
    def _parse_notification_channel(self, data: dict[str, Any]) -> NotificationChannel:
        ...
        try:
            ...
            EM.raise_error(
                ErrorCode.MDC-F15_INVALID_NOTIFICATION_CHANNEL_TYPE,
...
# ===========================================================================
# CP17 — Analytics Parser (merged from cp17_bi_analytics)
# ===========================================================================
...
class AnalyticsParser:
    ...
    def parse(self, raw: str) -> dict:
        ...
        try:
            ...
            EM.raise_error(
                ErrorCode.MDC-F15_ANALYTICS_PARSE_ERROR,
    ...
    def _parse_analytics_model(self, data: dict[str, Any]) -> "AnalyticsModel":  # type: ignore[name-defined]
        ...
        try:
            ...
            EM.raise_error(
                ErrorCode.MDC-F15_INVALID_SOURCE_TYPE,
        ...
        if isinstance(aggregation_list, list):
            for agg_str in aggregation_list:
                try:
                    ...
                    EM.raise_error(
                        ErrorCode.MDC-F15_INVALID_AGGREGATION_TYPE,
                        aggregation=agg_str,
    ...
    def _parse_dashboard_definition(self, data: dict[str, Any]) -> "DashboardDefinition":  # type: ignore[name-defined]
    ...
    def _parse_widget(self, data: dict[str, Any]) -> dict[str, Any]:
        """Parse dict thành widget dict."""
        from midicoder.packs.cp_full_monitoring.models import VisualizationType
        ...
        try:
            ...
            EM.raise_error(
                ErrorCode.MDC-F15_INVALID_VISUALIZATION_TYPE,
    ...
    def _parse_scheduled_report(self, data: dict[str, Any]) -> "ScheduledReport":  # type: ignore[name-defined]
        ...
        try:
            ...
            EM.raise_error(
                ErrorCode.MDC-F15_INVALID_REPORT_FREQUENCY,
