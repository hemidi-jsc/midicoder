...
class TestTestCase:
    ...
    def test_empty_id_raises_error(self):
        ...
        assert exc_info.value.code == ErrorCode.CP23_EMPTY_TEST_ID
    ...
    def test_missing_target_raises_error(self):
        ...
        assert exc_info.value.code == ErrorCode.CP23_MISSING_TEST_TARGET
...
class TestTestPolicy:
    ...
    def test_invalid_threshold_raises_error(self):
        ...
        assert exc_info.value.code == ErrorCode.CP23_INVALID_COVERAGE_THRESHOLD
...
class TestTestSuite:
    ...
    def test_duplicate_case_raises_error(self):
        ...
        with pytest.raises(MidicoderError) as exc_info:
            suite.add_case(dup)
        assert exc_info.value.code == ErrorCode.CP23_DUPLICATE_TEST_ID
