...
class TestConsentStatus:
    ...
    def test_status_active_value(self):
        from midicoder.packs.cp49_consent.models import ConsentStatus
...
class TestConsentPurpose:
    ...
    def test_purpose_analytics_value(self):
        from midicoder.packs.cp49_consent.models import ConsentPurpose
...
class TestConsentCategory:
    ...
    def test_category_necessary_value(self):
        from midicoder.packs.cp49_consent.models import ConsentCategory
...
class TestCookieCategory:
    ...
    def test_cookie_necessary_value(self):
        from midicoder.packs.cp49_consent.models import CookieCategory
...
class TestCommChannel:
    ...
    def test_channel_email_value(self):
        from midicoder.packs.cp49_consent.models import CommChannel
...
class TestCookiePreference:
    ...
    def test_create_valid_preference(self):
        from midicoder.packs.cp49_consent.models import CookiePreference
...
class TestConsentEngine:
    ...
    def test_engine_empty_collections_on_init(self):
        ...
        from midicoder.packs.cp49_consent.models import ConsentEngine
