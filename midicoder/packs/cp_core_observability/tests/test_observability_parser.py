...
Ki?m tra:
- ObservabilityParser: Parse YAML DSL h?p l?
...
"""
    ...
    def test_parse_single_metric_counter(self):
        """Ki?m tra parse metric counter h?p l?."""
        dsl = """
metrics:
...
"""
    ...
    def test_parse_metric_with_default_values(self):
        """Ki?m tra parse metric v?i default values."""
        dsl = """
metrics:
  - name: simple_metric
"""
    ...
    def test_parse_all_metric_types(self):
        """Ki?m tra parse t?t c? lo?i metric."""
        dsl = """
metrics:
  - name: counter_metric
    type: counter
...
"""
    ...
    def test_parse_metric_histogram_with_retention(self):
        """Ki?m tra parse metric histogram v?i retention ng?n."""
        dsl = """
metrics:
...
"""
    ...
    def test_parse_single_log_config(self):
        """Ki?m tra parse log config h?p l?."""
        dsl = """
logging:
...
"""
    ...
    def test_parse_log_config_with_span_id(self):
        """Ki?m tra parse log config c span_id."""
        dsl = """
logging:
...
"""
    ...
    def test_parse_all_log_levels(self):
        """Ki?m tra parse t?t c? log levels."""
        dsl = """
logging:
...
"""
    ...
    def test_parse_single_trace_config(self):
        """Ki?m tra parse trace config h?p l?."""
        dsl = """
tracing:
...
"""
    ...
    def test_parse_trace_config_b3_format(self):
        """Ki?m tra parse trace config v?i B3 format."""
        dsl = """
tracing:
...
"""
    ...
    def test_parse_trace_config_none_format(self):
        """Ki?m tra parse trace config v?i NONE format."""
        dsl = """
tracing:
...
"""
    ...
    def test_parse_full_dsl_all_sections(self):
        """Ki?m tra parse DSL d?y d? v?i c? 3 sections."""
        dsl = """
metrics:
  - name: http_requests_total
    type: counter
...
"""
    ...
    def test_parse_invalid_yaml_raises_error(self):
        """Ki?m tra parse YAML khng h?p l? throw error."""
        invalid_yaml = """
metrics:
  - name: test
    type: [invalid yaml
"""
    ...
    def test_parse_non_dict_yaml_raises_error(self):
        """Ki?m tra parse YAML list (khng ph?i mapping) throw error."""
        list_yaml = """
- item1
- item2
"""
    ...
    def test_parse_invalid_metric_type_raises_error(self):
        """Ki?m tra metric type khng h?p l? throw error."""
        dsl = """
metrics:
  - name: bad_metric
    type: invalid_type
"""
        ...
        assert exc_info.value.code == ErrorCode.MDC-C03_INVALID_METRIC_TYPE

    def test_parse_invalid_log_level_raises_error(self):
        """Ki?m tra log level khng h?p l? throw error."""
        dsl = """
logging:
...
"""
        with pytest.raises(MidicoderError) as exc_info:
            self.parser.parse(dsl)
        assert exc_info.value.code == ErrorCode.MDC-C03_INVALID_LOG_LEVEL

    def test_parse_invalid_propagation_format_raises_error(self):
        """Ki?m tra propagation format khng h?p l? throw error."""
        dsl = """
tracing:
  - service_name: test-service
...
"""
    ...
    def test_parse_metric_with_optional_fields(self):
        """Ki?m tra parse metric ch? c name, cc field cn l?i dng default."""
        dsl = """
metrics:
  - name: minimal_metric
"""
    ...
    def test_parse_log_config_with_defaults(self):
        """Ki?m tra parse log config ch? c service_name, defaults p d?ng."""
        dsl = """
logging:
...
"""
    ...
    def test_parse_trace_config_with_defaults(self):
        """Ki?m tra parse trace config ch? c service_name, defaults p d?ng."""
        dsl = """
tracing:
...
"""
    ...
    def test_parse_only_metrics_section(self):
        """Ki?m tra parse ch? c metrics, cc section khc r?ng."""
        dsl = """
metrics:
  - name: only_metric
    type: gauge
"""
    ...
    def test_parse_only_logging_section(self):
        """Ki?m tra parse ch? c logging, cc section khc r?ng."""
        dsl = """
logging:
...
"""
    ...
    def test_parse_only_tracing_section(self):
        """Ki?m tra parse ch? c tracing, cc section khc r?ng."""
        dsl = """
tracing:
...
"""
    ...
    def test_parse_empty_sections(self):
        """Ki?m tra parse v?i cc section r?ng."""
        dsl = """
metrics: []
logging: []
tracing: []
...
class TestOpenTelemetryParser:
    ...
    def test_parse_minimal_otel_config(self):
        """Ki?m tra parse OpenTelemetry config t?i thi?u."""
        dsl = """
opentelemetry:
  service_name: payment-service
"""
    ...
    def test_parse_full_otel_config(self):
        """Ki?m tra parse OpenTelemetry config d?y d?."""
        dsl = """
opentelemetry:
  service_name: api-gateway
...
"""
    ...
    def test_parse_otel_all_sampler_types(self):
        """Ki?m tra parse t?t c? sampler types."""
...
"""
    ...
    def test_parse_otel_all_protocols(self):
        """Ki?m tra parse t?t c? OTLP protocols."""
...
"""
    ...
    def test_parse_otel_disabled_features(self):
        """Ki?m tra parse OTel v?i features disabled."""
        dsl = """
opentelemetry:
  service_name: minimal-trace
  enable_traces: true
...
"""
    ...
    def test_parse_otel_without_exporter_section(self):
        """Ki?m tra parse OTel khng c exporter section dng default."""
        dsl = """
opentelemetry:
  service_name: test-svc
"""
    ...
    def test_parse_otel_invalid_sampler_type(self):
        """Ki?m tra sampler_type khng h?p l? throw error."""
        dsl = """
opentelemetry:
  service_name: test-svc
...
class TestLogShippingParser:
    ...
    def test_parse_minimal_log_shipping(self):
        """Ki?m tra parse log shipping config t?i thi?u."""
        dsl = """
log_shipping:
  enabled: true
"""
    ...
    def test_parse_full_log_shipping(self):
        """Ki?m tra parse log shipping config d?y d?."""
        dsl = """
log_shipping:
  enabled: true
  async_shipping: true
...
"""
    ...
    def test_parse_all_destination_types(self):
        """Ki?m tra parse t?t c? destination types."""
...
"""
    ...
    def test_parse_disabled_log_shipping(self):
        """Ki?m tra parse log shipping disabled."""
        dsl = """
log_shipping:
  enabled: false
...
"""
    ...
    def test_parse_log_shipping_with_single_stdout_dest(self):
        """Ki?m tra parse log shipping ch? c stdout destination."""
        dsl = """
log_shipping:
  enabled: true
  destinations:
...
"""
    ...
    def test_parse_log_shipping_invalid_destination_type(self):
        """Ki?m tra destination_type khng h?p l? throw error."""
        dsl = """
log_shipping:
  destinations:
...
class TestCombinedParser:
    """Test parse DSL c t?t c? sections cng lc."""

    def setup_method(self):
        self.parser = ObservabilityParser()

    def test_parse_all_sections_together(self):
        """Ki?m tra parse DSL c metrics, logging, tracing, opentelemetry, log_shipping."""
        dsl = """
metrics:
  - name: http_requests_total
    type: counter
...
"""
    ...
    def test_parse_otel_and_log_shipping_only(self):
        """Ki?m tra parse ch? c opentelemetry + log_shipping."""
        dsl = """
opentelemetry:
  service_name: test-svc
log_shipping:
