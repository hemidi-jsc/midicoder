...
# Recipes
from midicoder.packs.cp_full_file_media.recipes import (
    S3StorageRecipe,
    LocalStorageRecipe,
    MinIORecipe,
    ImageUploadRecipe,
...
# Frontend Emitters
try:
    from midicoder.packs.cp_full_file_media.angular import (
...
try:
    from midicoder.packs.cp_full_file_media.react import (
