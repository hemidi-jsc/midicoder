...
class TestStorageProfile:
    ...
    def test_create_valid_s3_profile(self):
        ...
        from midicoder.packs.cp_full_file_media.models import StorageProfile, StorageBackend
    ...
    def test_empty_name_raises_error(self):
        ...
        assert exc_info.value.code == ErrorCode.MDC-F35_EMPTY_PROFILE_NAME

    def test_invalid_backend_type_raises_error(self):
        """Backend type không hợp lệ → MDC-CP11-002."""
        from midicoder.packs.cp_full_file_media.models import StorageProfile
        ...
        assert exc_info.value.code == ErrorCode.MDC-F35_INVALID_BACKEND_TYPE
    ...
    def test_s3_without_bucket_raises_error(self):
        ...
        assert exc_info.value.code == ErrorCode.MDC-F35_EMPTY_BUCKET_NAME
...
class TestUploadPolicy:
    ...
    def test_create_valid_policy(self):
        ...
        from midicoder.packs.cp_full_file_media.models import UploadPolicy
    ...
    def test_empty_name_raises_error(self):
        ...
        assert exc_info.value.code == ErrorCode.MDC-F35_MISSING_POLICY
    ...
    def test_empty_content_types_raises_error(self):
        ...
        assert exc_info.value.code == ErrorCode.MDC-F35_INVALID_CONTENT_TYPE
    ...
    def test_zero_max_size_raises_error(self):
        ...
        assert exc_info.value.code == ErrorCode.MDC-F35_FILE_SIZE_EXCEEDED
    ...
    def test_empty_extensions_raises_error(self):
        ...
        assert exc_info.value.code == ErrorCode.MDC-F35_INVALID_EXTENSION
...
class TestMediaTransform:
    ...
    def test_create_valid_resize(self):
        ...
        from midicoder.packs.cp_full_file_media.models import MediaTransform, TransformType
    ...
    def test_empty_name_raises_error(self):
        ...
        assert exc_info.value.code == ErrorCode.MDC-F35_TRANSFORM_INVALID_PARAM

    def test_invalid_transform_type_raises_error(self):
        """Transform type không hợp lệ → MDC-CP11-009."""
        from midicoder.packs.cp_full_file_media.models import MediaTransform
...
class TestFileStorageCollection:
    ...
    def test_add_profiles(self):
        ...
        from midicoder.packs.cp_full_file_media.models import (
    ...
    def test_get_by_id_not_found(self):
        ...
        from midicoder.packs.cp_full_file_media.models import FileStorageCollection
