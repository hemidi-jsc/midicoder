...
# Pack is at: midicoder/packs/cp_full_file_media/
# This test is at: midicoder/packs/cp_full_file_media/tests/
...
class TestPackStructure:
    ...
    def test_pack_internal_id(self, pack):
        assert pack["pack"]["internal_id"] == "cp_full_file_media"
...
class TestPackEmittersExist:
    ...
    def test_fastapi_emitter_exists(self):
        from midicoder.packs.cp_full_file_media.fastapi import FastAPIFileStorageEmitter
        assert FastAPIFileStorageEmitter

    def test_nestjs_emitter_exists(self):
        from midicoder.packs.cp_full_file_media.nestjs import NestJSFileStorageEmitter
        assert NestJSFileStorageEmitter

    def test_angular_emitter_exists(self):
        from midicoder.packs.cp_full_file_media.angular import AngularFileStorageEmitter
        assert AngularFileStorageEmitter

    def test_react_emitter_exists(self):
        from midicoder.packs.cp_full_file_media.react import ReactFileStorageEmitter
