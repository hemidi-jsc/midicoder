...
from midicoder.packs.cp_full_rbac.models import Role, PolicyRule, RBACConfig
...
class RBACParser:
    ...
    - Role objects (từ packs.cp_full_rbac.models)
    - PolicyRule objects (từ packs.cp_full_rbac.models)
