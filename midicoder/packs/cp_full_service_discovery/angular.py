...
class AngularFeatureFlagEmitter:
    ...
    Render templates từ `stacks/angular/cp_full_service_discovery/`
    ...
    # Mapping template name -> output path (khớp với file thực tế trong stacks/angular/cp_full_service_discovery/)
