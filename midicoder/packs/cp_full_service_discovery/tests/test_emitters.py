...
# tests/ is at: midicoder/packs/cp_full_service_discovery/tests/
# 4 parents up = midicoder/ (which contains both packs/ and stacks/)
PROJECT_ROOT = Path(__file__).parent.parent.parent.parent
FASTAPI_TEMPLATE_DIR = PROJECT_ROOT / "stacks" / "fastapi" / "cp_full_service_discovery"
NESTJS_TEMPLATE_DIR = PROJECT_ROOT / "stacks" / "nestjs" / "cp_full_service_discovery"
ANGULAR_TEMPLATE_DIR = PROJECT_ROOT / "stacks" / "angular" / "cp_full_service_discovery"
REACT_TEMPLATE_DIR = PROJECT_ROOT / "stacks" / "react" / "cp_full_service_discovery"
