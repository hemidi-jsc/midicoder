...
# midicoder/packs/cp_full_service_discovery/tests/
# parent.parent = cp_full_service_discovery/
...
class TestFastAPITemplates:
    ...
    def _get_template_dir(self):
        return Path(__file__).parent.parent.parent.parent.parent / "stacks" / "fastapi" / "core" / "cp_full_service_discovery"
...
class TestNestJSTemplates:
    ...
    def _get_template_dir(self):
        return Path(__file__).parent.parent.parent.parent.parent / "stacks" / "nestjs" / "core" / "cp_full_service_discovery"
...
class TestAngularTemplates:
    ...
    def _get_template_dir(self):
        return Path(__file__).parent.parent.parent.parent.parent / "stacks" / "angular" / "core" / "cp_full_service_discovery"
...
class TestReactTemplates:
    ...
    def _get_template_dir(self):
        return Path(__file__).parent.parent.parent.parent.parent / "stacks" / "react" / "core" / "cp_full_service_discovery"
...
STACK_DIRS_37 = {
    "fastapi": MIDICODER_ROOT_37 / "stacks" / "fastapi" / "core" / "cp_full_service_discovery",
    "nestjs": MIDICODER_ROOT_37 / "stacks" / "nestjs" / "core" / "cp_full_service_discovery",
    "angular": MIDICODER_ROOT_37 / "stacks" / "angular" / "core" / "cp_full_service_discovery",
    "react": MIDICODER_ROOT_37 / "stacks" / "react" / "core" / "cp_full_service_discovery",
}
