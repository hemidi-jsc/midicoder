...
from midicoder.packs.cp01_domain_model.models import Command, CommandGuard, GuardType, ValidationResult
...
class TestFraudDetectionGuard:
    ...
    async def test_fraud_detection_velocity_exceeded(self):
        ...
        assert exc_info.value.code == ErrorCode.MDC-B01_GUARD_FRAUD_VELOCITY_EXCEEDED
    ...
    async def test_fraud_detection_amount_threshold_exceeded(self):
        ...
        assert exc_info.value.code == ErrorCode.MDC-B01_GUARD_FRAUD_AMOUNT_THRESHOLD
    ...
    async def test_fraud_detection_pattern_anomaly(self):
        ...
        assert exc_info.value.code == ErrorCode.MDC-B01_GUARD_FRAUD_PATTERN_ANOMALY
    ...
    async def test_fraud_detection_external_blocked(self):
        ...
        assert exc_info.value.code == ErrorCode.MDC-B01_GUARD_FRAUD_EXTERNAL_BLOCKED
...
class TestSafetyCheckGuard:
    ...
    async def test_safety_check_equipment_unsafe(self):
        ...
        assert exc_info.value.code == ErrorCode.MDC-B01_GUARD_SAFETY_EQUIPMENT_UNSAFE
    ...
    async def test_safety_check_personnel_not_certified(self):
        ...
        assert exc_info.value.code == ErrorCode.MDC-B01_GUARD_SAFETY_PERSONNEL_UNCERTIFIED
    ...
    async def test_safety_check_process_non_compliant(self):
        ...
        assert exc_info.value.code == ErrorCode.MDC-B01_GUARD_SAFETY_PROCESS_NON_COMPLIANT
    ...
    async def test_safety_check_hazards_detected(self):
        ...
        assert exc_info.value.code == ErrorCode.MDC-B01_GUARD_SAFETY_HAZARD_DETECTED
...
class TestClaimsValidationGuard:
    ...
    async def test_claims_validation_missing_policy_id(self):
        ...
        assert exc_info.value.code == ErrorCode.MDC-B01_GUARD_CLAIMS_NOT_COVERED
    ...
    async def test_claims_validation_outside_period(self):
        ...
        assert exc_info.value.code == ErrorCode.MDC-B01_GUARD_CLAIMS_OUTSIDE_PERIOD
    ...
    async def test_claims_validation_exceeds_limit(self):
        ...
        assert exc_info.value.code == ErrorCode.MDC-B01_GUARD_CLAIMS_EXCEEDS_LIMIT
    ...
    async def test_claims_validation_excluded(self):
        ...
        assert exc_info.value.code == ErrorCode.MDC-B01_GUARD_CLAIMS_EXCLUDED
