...
FASTAPI_TEMPLATE_DIR = MIDICODER_ROOT / "stacks" / "fastapi" / "core" / "cp_full_i18n"
NESTJS_TEMPLATE_DIR = MIDICODER_ROOT / "stacks" / "nestjs" / "core" / "cp_full_i18n"
ANGULAR_TEMPLATE_DIR = MIDICODER_ROOT / "stacks" / "angular" / "core" / "cp_full_i18n"
REACT_TEMPLATE_DIR = MIDICODER_ROOT / "stacks" / "react" / "core" / "cp_full_i18n"
