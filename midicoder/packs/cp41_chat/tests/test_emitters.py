...
def _make_ir():
    ...
    from midicoder.packs.cp41_chat.recipes import basic_chat_recipe
...
class TestFastAPIChatEmitter:
    ...
    def test_init_raises_error_when_template_dir_not_found(self):
        ...
        from midicoder.packs.cp41_chat.fastapi import FastAPIChatEmitter
    ...
    def test_emit_with_redis_context(self, tmp_path: Path):
        ...
        from midicoder.packs.cp41_chat.fastapi import FastAPIChatEmitter
        from midicoder.packs.cp41_chat.recipes import full_messaging_recipe
...
class TestNestJSChatEmitter:
    ...
    def test_init_raises_error_when_template_dir_not_found(self):
        """Kiểm tra __init__ raise MidicoderError khi template dir không tìm thấy."""
        from midicoder.packs.cp41_chat.nestjs import NestJSChatEmitter
...
class TestAngularChatEmitter:
    ...
    def test_init_raises_error_when_template_dir_not_found(self):
        """Kiểm tra __init__ raise MidicoderError khi template dir không tìm thấy."""
        from midicoder.packs.cp41_chat.angular import AngularChatEmitter
...
class TestReactChatEmitter:
    ...
    def test_init_raises_error_when_template_dir_not_found(self):
        """Kiểm tra __init__ raise MidicoderError khi template dir không tìm thấy."""
        from midicoder.packs.cp41_chat.react import ReactChatEmitter
