...
# __file__ = .../midicoder/packs/cp_full_catalog/tests/test_templates.py
# parent x6 = midicoder-ce/
MIDICODER_ROOT = Path(__file__).parent.parent.parent.parent.parent.parent

PACK_YML = MIDICODER_ROOT / "midicoder" / "emitters" / "core" / "cp_full_catalog" / "pack.yml"

STACK_DIRS = {
    "fastapi": MIDICODER_ROOT / "midicoder" / "stacks" / "fastapi" / "core" / "cp_full_catalog",
    "nestjs": MIDICODER_ROOT / "midicoder" / "stacks" / "nestjs" / "core" / "cp_full_catalog",
    "angular": MIDICODER_ROOT / "midicoder" / "stacks" / "angular" / "core" / "cp_full_catalog",
    "react": MIDICODER_ROOT / "midicoder" / "stacks" / "react" / "core" / "cp_full_catalog",
}
...
class TestPackYML:
    ...
    def test_pack_internal_id(self):
        """Internal ID là cp_full_catalog."""
        data = _load_pack()
        assert data["pack"]["internal_id"] == "cp_full_catalog"
