...
from midicoder.packs.cp_full_catalog.recipes import basic_catalog_recipe
...
FASTAPI_STACK_DIR = MIDICODER_ROOT / "midicoder" / "stacks" / "fastapi" / "core" / "cp_full_catalog"
NESTJS_STACK_DIR = MIDICODER_ROOT / "midicoder" / "stacks" / "nestjs" / "core" / "cp_full_catalog"
ANGULAR_STACK_DIR = MIDICODER_ROOT / "midicoder" / "stacks" / "angular" / "core" / "cp_full_catalog"
REACT_STACK_DIR = MIDICODER_ROOT / "midicoder" / "stacks" / "react" / "core" / "cp_full_catalog"
...
class TestFastAPICatalogEmitter:
    ...
    def test_init_raises_error_when_template_dir_not_found(self):
        ...
        from midicoder.packs.cp_full_catalog.fastapi import (
...
class TestNestJSCatalogEmitter:
    ...
    def test_init_raises_error_when_template_dir_not_found(self):
        """Kiểm tra __init__ raise MidicoderError khi template dir không tìm thấy."""
        from midicoder.packs.cp_full_catalog.nestjs import (
...
class TestAngularCatalogEmitter:
    ...
    def test_init_raises_error_when_template_dir_not_found(self):
        """Kiểm tra __init__ raise MidicoderError khi template dir không tìm thấy."""
        from midicoder.packs.cp_full_catalog.angular import (
...
class TestReactCatalogEmitter:
    ...
    def test_init_raises_error_when_template_dir_not_found(self):
        """Kiểm tra __init__ raise MidicoderError khi template dir không tìm thấy."""
        from midicoder.packs.cp_full_catalog.react import (
            ReactCatalogEmitter,
        )
        with pytest.raises(MidicoderError):
