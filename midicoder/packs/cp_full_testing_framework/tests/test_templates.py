...
class TestTemplatesExist:
    ...
    def _get_stacks_dir(self) -> Path:
        ...
        Path:
        test_templates.py → tests/ → cp_full_testing_framework/ → packs/ → midicoder/
    ...
    def test_fastapi_templates_exist(self):
        ...
        base = self._get_stacks_dir() / "fastapi" / "cp_full_testing_framework"
        expected = [
            "pytest.ini.jinja2",
            "conftest.py.jinja2",
    ...
    def test_nestjs_templates_exist(self):
        ...
        base = self._get_stacks_dir() / "nestjs" / "core" / "cp_full_testing_framework"
        expected = [
    ...
    def test_angular_templates_exist(self):
        ...
        base = self._get_stacks_dir() / "angular" / "core" / "cp_full_testing_framework"
        expected = [
    ...
    def test_react_templates_exist(self):
        ...
        base = self._get_stacks_dir() / "react" / "core" / "cp_full_testing_framework"
        expected = [
    ...
    def test_total_template_count(self):
        ...
        for stack in ["fastapi", "nestjs", "angular", "react"]:
            base = self._get_stacks_dir() / stack / "core" / "cp_full_testing_framework"
            if base.exists():
...
def _render_template(stack: str, template_name: str) -> str:
    ...
    template_path = Path(__file__).resolve().parents[4] / "stacks" / stack / "core" / "cp_full_testing_framework"
    try:
