...
from midicoder.packs.cp_full_testing_framework.parser import TestParser, STACK_TO_FRAMEWORK
...
class TestTestParser:
    ...
    def test_parse_invalid_yaml(self):
        ...
        assert exc_info.value.code == ErrorCode.MDC-F05_DSL_PARSE_ERROR
...
"""
    ...
    def test_parse_invalid_test_type(self):
        ...
        assert exc_info.value.code == ErrorCode.MDC-F05_INVALID_TEST_TYPE
    ...
    def test_parse_invalid_framework(self):
        ...
        assert exc_info.value.code == ErrorCode.MDC-F05_INVALID_FRAMEWORK
    ...
    def test_parse_invalid_assertion_check(self):
        ...
        assert exc_info.value.code == ErrorCode.MDC-F05_INVALID_ASSERTION
