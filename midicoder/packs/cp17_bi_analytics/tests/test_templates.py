...
EXPECTED_TEMPLATES = [
    # FastAPI (2 templates)
    "midicoder/stacks/fastapi/cp17_bi_analytics/analytics_service.py.jinja2",
    "midicoder/stacks/fastapi/cp17_bi_analytics/analytics_router.py.jinja2",
    # NestJS (3 templates)
    "midicoder/stacks/nestjs/cp17_bi_analytics/analytics.module.ts.jinja2",
    "midicoder/stacks/nestjs/cp17_bi_analytics/analytics.service.ts.jinja2",
    "midicoder/stacks/nestjs/cp17_bi_analytics/analytics.controller.ts.jinja2",
    # Angular (2 templates)
    "midicoder/stacks/angular/cp17_bi_analytics/analytics_widget.component.ts.jinja2",
    "midicoder/stacks/angular/cp17_bi_analytics/report_viewer.component.ts.jinja2",
    # React (3 templates)
    "midicoder/stacks/react/cp17_bi_analytics/types.ts.jinja2",
    "midicoder/stacks/react/cp17_bi_analytics/AnalyticsChart.tsx.jinja2",
    "midicoder/stacks/react/cp17_bi_analytics/ReportTable.tsx.jinja2",
]
...
class TestTemplateContent:
    ...
    def test_fastapi_service_has_analytics_class(self):
        ...
        content = self._read_template("midicoder/stacks/fastapi/cp17_bi_analytics/analytics_service.py.jinja2")
    ...
    def test_fastapi_router_has_router(self):
        ...
        content = self._read_template("midicoder/stacks/fastapi/cp17_bi_analytics/analytics_router.py.jinja2")
        assert len(content) > 10, "Template quá ngắn hoặc rỗng"
    ...
    def test_nestjs_module_has_module_decorator(self):
        ...
        content = self._read_template("midicoder/stacks/nestjs/cp17_bi_analytics/analytics.module.ts.jinja2")
        assert len(content) > 10, "Template quá ngắn hoặc rỗng"
    ...
    def test_nestjs_service_has_injectable(self):
        ...
        content = self._read_template("midicoder/stacks/nestjs/cp17_bi_analytics/analytics.service.ts.jinja2")
        assert len(content) > 10, "Template quá ngắn hoặc rỗng"
    ...
    def test_nestjs_controller_has_controller_decorator(self):
        ...
        content = self._read_template("midicoder/stacks/nestjs/cp17_bi_analytics/analytics.controller.ts.jinja2")
        assert len(content) > 10, "Template quá ngắn hoặc rỗng"
    ...
    def test_angular_widget_has_component(self):
        ...
        content = self._read_template("midicoder/stacks/angular/cp17_bi_analytics/analytics_widget.component.ts.jinja2")
        assert len(content) > 10, "Template quá ngắn hoặc rỗng"
    ...
    def test_angular_report_viewer_has_component(self):
        ...
        content = self._read_template("midicoder/stacks/angular/cp17_bi_analytics/report_viewer.component.ts.jinja2")
        assert len(content) > 10, "Template quá ngắn hoặc rỗng"
        assert "@Component" in content, "Thiếu @Component decorator"
    ...
    def test_react_types_has_interfaces(self):
        ...
        content = self._read_template("midicoder/stacks/react/cp17_bi_analytics/types.ts.jinja2")
        assert len(content) > 10, "Template quá ngắn hoặc rỗng"
    ...
    def test_react_chart_has_component(self):
        ...
        content = self._read_template("midicoder/stacks/react/cp17_bi_analytics/AnalyticsChart.tsx.jinja2")
        assert len(content) > 10, "Template quá ngắn hoặc rỗng"
    ...
    def test_react_table_has_component(self):
        ...
        content = self._read_template("midicoder/stacks/react/cp17_bi_analytics/ReportTable.tsx.jinja2")
        assert len(content) > 10, "Template quá ngắn hoặc rỗng"
