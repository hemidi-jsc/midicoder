...
class TestParserEngineWiring:
    ...
    def test_parse_models_registered_in_engine(self):
        ...
        from midicoder.packs.cp17_bi_analytics.parser import AnalyticsParser
        from midicoder.packs.cp17_bi_analytics.analytics_engine import AnalyticsEngine
    ...
    def test_parse_dashboards_created_in_builder(self):
        ...
        from midicoder.packs.cp17_bi_analytics.parser import AnalyticsParser
        from midicoder.packs.cp17_bi_analytics.dashboard_builder import DashboardBuilder
...
class TestCP15ToCP17DataFlow:
    ...
    def test_engine_query_max_min_aggregation(self):
        ...
        from midicoder.packs.cp17_bi_analytics.parser import AnalyticsParser
        from midicoder.packs.cp17_bi_analytics.analytics_engine import AnalyticsEngine
        from midicoder.packs.cp17_bi_analytics.models import AggregationType
...
class TestQueryResultImmutability:
    ...
    def test_query_result_is_frozen(self):
        ...
        from midicoder.packs.cp17_bi_analytics.analytics_engine import QueryResult
...
class TestReportSnapshotImmutability:
    ...
    def test_report_snapshot_is_frozen(self):
        ...
        from midicoder.packs.cp17_bi_analytics.report_scheduler import ReportSnapshot
...
class TestInitExports:
    ...
    def test_all_models_exported(self):
        ...
        from midicoder.packs.cp17_bi_analytics import (
            AnalyticsModel,
            DashboardDefinition,
            ScheduledReport,
        )
    ...
    def test_all_list_complete(self):
        ...
        from midicoder.packs.cp17_bi_analytics import __all__
        expected = {
