...
STACK_DIRS = {
    "fastapi": PROJECT_ROOT / "stacks" / "fastapi" / "core" / "cp_full_documentation",
    "nestjs": PROJECT_ROOT / "stacks" / "nestjs" / "core" / "cp_full_documentation",
    "angular": PROJECT_ROOT / "stacks" / "angular" / "core" / "cp_full_documentation",
    "react": PROJECT_ROOT / "stacks" / "react" / "core" / "cp_full_documentation",
}
...
class TestTemplateDiscovery:
    ...
    def test_fastapi_templates_exist(self) -> None:
        d = PROJECT_ROOT / "stacks" / "fastapi" / "core" / "cp_full_documentation"
    ...
    def test_nestjs_templates_exist(self) -> None:
        d = PROJECT_ROOT / "stacks" / "nestjs" / "core" / "cp_full_documentation"
    ...
    def test_angular_templates_exist(self) -> None:
        d = PROJECT_ROOT / "stacks" / "angular" / "core" / "cp_full_documentation"
    ...
    def test_react_templates_exist(self) -> None:
        d = PROJECT_ROOT / "stacks" / "react" / "core" / "cp_full_documentation"
        assert (d / "storybook_main.ts.jinja2").exists()
        assert (d / "storybook_preview.ts.jinja2").exists()
        assert (d / "typedoc.json.jinja2").exists()
        assert (d / "components.md.jinja2").exists()
    ...
    def test_pack_yml_exists(self) -> None:
        d = PROJECT_ROOT / "emitters" / "core" / "cp_full_documentation"
