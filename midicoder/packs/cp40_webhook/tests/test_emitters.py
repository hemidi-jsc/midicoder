...
def _make_ir():
    ...
    from midicoder.packs.cp40_webhook.recipes import basic_webhook_recipe
...
class TestFastAPIWebhookEmitter:
    ...
    def test_init_raises_error_when_template_dir_not_found(self):
        from midicoder.packs.cp40_webhook.fastapi import (
...
class TestNestJSWebhookEmitter:
    ...
    def test_init_raises_error_when_template_dir_not_found(self):
        from midicoder.packs.cp40_webhook.nestjs import (
...
class TestAngularWebhookEmitter:
    ...
    def test_init_raises_error_when_template_dir_not_found(self):
        from midicoder.packs.cp40_webhook.angular import (
...
class TestReactWebhookEmitter:
    ...
    def test_init_raises_error_when_template_dir_not_found(self):
        from midicoder.packs.cp40_webhook.react import (
            ReactWebhookEmitter,
        )
