...
class TestDispatchStatus:
    ...
    def test_dispatch_status_pending_value(self):
        from midicoder.packs.cp40_webhook.models import DispatchStatus
...
class TestWebhookSubscription:
    ...
    def test_create_valid_subscription(self):
        from midicoder.packs.cp40_webhook.models import WebhookSubscription
...
class TestWebhookDispatch:
    ...
    def test_dispatch_auto_timestamp(self):
        from midicoder.packs.cp40_webhook.models import WebhookDispatch
        d = WebhookDispatch(
            dispatch_id="disp_001",
            subscription_id="wh_001",
            event_type="order.created",
...
class TestWebhookDeliveryAttempt:
    ...
    def test_create_attempt(self):
        from midicoder.packs.cp40_webhook.models import WebhookDeliveryAttempt
...
class TestRetryPolicy:
    ...
    def test_get_delay_attempt_zero_equals_base(self):
        from midicoder.packs.cp40_webhook.models import RetryPolicy
...
class TestWebhookDispatcher:
    ...
    def _make_subscription(self, sid: str, etype: str, url: str = "https://example.com/hook",
        ...
        from midicoder.packs.cp40_webhook.models import WebhookSubscription, WebhookStatus
    ...
    def test_add_subscription(self):
        from midicoder.packs.cp40_webhook.models import WebhookDispatcher, WebhookSubscription, WebhookStatus
    ...
    def test_remove_nonexistent_subscription(self):
        from midicoder.packs.cp40_webhook.models import WebhookDispatcher
        dispatcher = WebhookDispatcher()
    ...
    def test_get_subscriptions_by_event_filters_inactive(self):
        from midicoder.packs.cp40_webhook.models import WebhookDispatcher, WebhookStatus
        dispatcher = WebhookDispatcher()
        dispatcher.add_subscription(self._make_subscription("wh_001", "order.created"))
