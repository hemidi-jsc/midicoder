# coding: utf-8
"""
Infrastructure Emitter cho I03: CI/CD Pipeline Generator.
...
class CICDInfrastructureEmitter:
    ...
    Render templates từ `stacks/infrastructure/cp_infra_cicd/`
    ...
    def __init__(self, stack_dir: str | Path) -> None:
        ...
        self.template_dir = self.stack_dir / "cp_infra_cicd"
