...
class TestJobPriority(TestCase):
    ...
    def test_low_priority_exists(self):
        ...
        from midicoder.packs.cp_full_workflow_scheduler.scheduler import JobPriority
...
class TestSchedulePolicy(TestCase):
    ...
    def test_cron_policy_creation(self):
        ...
        from midicoder.packs.cp_full_workflow_scheduler.scheduler import SchedulePolicy
...
class TestJobDefinition(TestCase):
    ...
    def test_job_definition_creation(self):
        ...
        from midicoder.packs.cp_full_workflow_scheduler.scheduler import JobDefinition, SchedulePolicy, JobPriority
        job = JobDefinition(
    ...
    def test_job_definition_empty_id_raises(self):
        ...
        from midicoder.packs.cp_full_workflow_scheduler.scheduler import JobDefinition, SchedulePolicy
        with self.assertRaises(ValueError) as ctx:
            JobDefinition(
                job_id="",
                name="Test",
    ...
    def test_job_definition_from_dict(self):
        ...
        from midicoder.packs.cp_full_workflow_scheduler.scheduler import JobDefinition
        d = {
            "job_id": "import_data",
            "name": "Import dữ liệu",
...
class TestJobInstance(TestCase):
    ...
    def test_job_instance_creation(self):
        ...
        from midicoder.packs.cp_full_workflow_scheduler.scheduler import JobInstance
