...
class TestWorkflowDefinition:
    ...
    def test_workflow_definition_initial_state_must_exist(self):
        ...
        assert exc_info.value.code == ErrorCode.MDC-B01_WORKFLOW_INVALID_STATE
...
class TestGuard:
    ...
    def test_permission_guard_requires_permission(self):
        ...
        assert exc_info.value.code == ErrorCode.MDC-B01_WORKFLOW_GUARD_FAILED
...
class TestEffect:
    ...
    def test_event_effect_requires_publish(self):
        ...
        assert exc_info.value.code == ErrorCode.MDC-B01_WORKFLOW_EFFECT_FAILED
