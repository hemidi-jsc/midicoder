...
class TestStateMachine(TestCase):
    ...
    def _make_workflow(self):
        ...
        from midicoder.packs.cp_full_workflow_scheduler.models import WorkflowDefinition, Transition
        transitions = [
...
class TestEventStore(TestCase):
    ...
    def _make_event(self, instance_id=None, workflow_name="order", event_type="transition"):
        ...
        from midicoder.packs.cp_full_workflow_scheduler.engine.event_store import WorkflowEvent
    ...
    def test_append_event(self):
        ...
        from midicoder.packs.cp_full_workflow_scheduler.engine.event_store import EventStore
        store = EventStore()
        iid = uuid4()
