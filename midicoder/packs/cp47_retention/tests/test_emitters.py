...
from midicoder.packs.cp47_retention.parser import parse_to_ir, RetentionIR
...
class TestFastAPIEmitter:
    @pytest.fixture
    def emitter(self):
        from midicoder.packs.cp47_retention.fastapi import FastAPIRetentionEmitter
...
class TestNestJSEmitter:
    @pytest.fixture
    def emitter(self):
        from midicoder.packs.cp47_retention.nestjs import NestJSRetentionEmitter
        stacks_dir = PACKAGE_DIR / "stacks"
...
class TestAngularEmitter:
    @pytest.fixture
    def emitter(self):
        from midicoder.packs.cp47_retention.angular import AngularRetentionEmitter
        stacks_dir = PACKAGE_DIR / "stacks"
...
class TestReactEmitter:
    @pytest.fixture
    def emitter(self):
        from midicoder.packs.cp47_retention.react import ReactRetentionEmitter
        stacks_dir = PACKAGE_DIR / "stacks"
...
class TestInitModule:
    ...
    def test_init_exports_models(self):
        from midicoder.packs.cp47_retention import (
            RetentionEngine,
            RetentionPolicy,
            ArchivedRecord,
            ErasureRequest,
