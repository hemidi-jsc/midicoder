...
class TestComponentType:
    ...
    def test_component_type_values(self):
        ...
        from midicoder.packs.cp_full_ui_components.models import ComponentType
...
class TestFieldType:
    ...
    def test_field_type_values(self):
        ...
        from midicoder.packs.cp_full_ui_components.models import FieldType
...
class TestFormFieldSpec:
    ...
    def test_form_field_spec_creation(self):
        ...
        from midicoder.packs.cp_full_ui_components.models import FormFieldSpec, FieldType
        spec = FormFieldSpec(
            field_name="email",
    ...
    def test_form_field_spec_from_dict(self):
        ...
        from midicoder.packs.cp_full_ui_components.models import FormFieldSpec
        data = {
            "field_name": "password",
            "field_type": "text",
            "label": "Mật khẩu",
...
class TestTableColumn:
    ...
    def test_table_column_creation(self):
        ...
        from midicoder.packs.cp_full_ui_components.models import TableColumn
        col = TableColumn(
            field_name="name",
            label="Tên",
            sortable=True,
...
class TestTableSpec:
    ...
    def test_table_spec_creation(self):
        ...
        from midicoder.packs.cp_full_ui_components.models import TableSpec, TableColumn
        spec = TableSpec(
            entity_id="Order",
            columns=[
    ...
    def test_table_spec_empty_entity_id_raises(self):
        ...
        from midicoder.packs.cp_full_ui_components.models import TableSpec
        with pytest.raises(MidicoderError) as exc_info:
