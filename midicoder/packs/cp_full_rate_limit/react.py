# coding: utf-8
"""
React emitter cho CP48 — API Rate Limiting & Quota Management.

Emit frontend files cho React:
...
class ReactRateLimitEmitter:
    """Emitter cho React stack.

    Render Jinja2 templates từ stack directory và generate code cho React.
    ...
    def emit(self, ir: RateLimitIR, output_dir: str | Path) -> list[GeneratedFile]:
        ...
        templates = [
            ("RateLimitDashboard.tsx.jinja2", "src/rate-limit/RateLimitDashboard.tsx"),
            ("QuotaStatus.tsx.jinja2", "src/rate-limit/QuotaStatus.tsx"),
            ("useRateLimit.ts.jinja2", "src/rate-limit/hooks/useRateLimit.ts"),
        ]
