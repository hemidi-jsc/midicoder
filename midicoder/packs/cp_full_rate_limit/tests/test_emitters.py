...
from midicoder.packs.cp_full_rate_limit.fastapi import (
    FastAPIRateLimitEmitter,
    GeneratedFile,
)
from midicoder.packs.cp_full_rate_limit.nestjs import NestJSRateLimitEmitter
from midicoder.packs.cp_full_rate_limit.angular import AngularRateLimitEmitter
from midicoder.packs.cp_full_rate_limit.react import ReactRateLimitEmitter
...
def _get_template_dir(stack: str) -> str:
    ...
    return str(Path(__file__).parents[4] / "stacks" / stack / "core" / "cp_full_rate_limit")
