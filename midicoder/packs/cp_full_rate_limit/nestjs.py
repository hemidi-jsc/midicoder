# coding: utf-8
"""
NestJS emitter cho CP48 — API Rate Limiting & Quota Management.

Emit infrastructure files cho NestJS:
...
class NestJSRateLimitEmitter:
    """Emitter cho NestJS stack.

    Render Jinja2 templates từ stack directory và generate code cho NestJS.
    ...
    def emit(self, ir: RateLimitIR, output_dir: str | Path) -> list[GeneratedFile]:
        ...
        templates = [
            ("rate-limit.service.ts.jinja2", "src/rate-limit/rate-limit.service.ts"),
            ("rate-limit.middleware.ts.jinja2", "src/rate-limit/rate-limit.middleware.ts"),
            ("rate-limit.module.ts.jinja2", "src/rate-limit/rate-limit.module.ts"),
            ("rate-limit.controller.ts.jinja2", "src/rate-limit/rate-limit.controller.ts"),
            ("quota.service.ts.jinja2", "src/rate-limit/quota.service.ts"),
        ]
