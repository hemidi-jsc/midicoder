# coding: utf-8
"""
Angular emitter cho CP48 — API Rate Limiting & Quota Management.

Emit frontend files cho Angular:
- rate-limit-dashboard.component.ts
- quota-status.component.ts
...
from midicoder.packs.cp_full_rate_limit.parser import RateLimitIR
...
class AngularRateLimitEmitter:
    """Emitter cho Angular stack.

    Render Jinja2 templates từ stack directory và generate code cho Angular.
    ...
    def __init__(self, stack_dir: str | Path) -> None:
        ...
        if not self.stack_dir.exists():
            raise EM.raise_error(
                ErrorCode.MDC-F30_RATE_LIMIT_POLICY_NOT_FOUND,
    ...
    def emit(self, ir: RateLimitIR, output_dir: str | Path) -> list[GeneratedFile]:
        ...
        templates = [
            ("rate-limit-dashboard.component.ts.jinja2", "src/app/rate-limit/components/rate-limit-dashboard.component.ts"),
            ("quota-status.component.ts.jinja2", "src/app/rate-limit/components/quota-status.component.ts"),
            ("rate-limit.service.ts.jinja2", "src/app/core/rate-limit/rate-limit.service.ts"),
        ]
