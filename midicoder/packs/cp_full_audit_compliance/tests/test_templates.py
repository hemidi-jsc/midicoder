...
class TestFastApiAuditLogger(TestCase):
    ...
    def setUp(self):
        self.template_path = Path("midicoder/stacks/fastapi/cp_full_audit_compliance/audit_logger.py.jinja2")
...
class TestFastApiAuditMiddleware(TestCase):
    ...
    def setUp(self):
        self.template_path = Path("midicoder/stacks/fastapi/cp_full_audit_compliance/audit_middleware.py.jinja2")
...
class TestNestJsAuditModule(TestCase):
    ...
    def setUp(self):
        self.template_path = Path("midicoder/stacks/nestjs/cp_full_audit_compliance/audit.module.ts.jinja2")
...
class TestAngularAuditLoggerService(TestCase):
    ...
    def setUp(self):
        self.template_path = Path("midicoder/stacks/angular/cp_full_audit_compliance/audit_logger_service.ts.jinja2")
...
class TestAngularAuditLogListComponent(TestCase):
    ...
    def setUp(self):
        self.template_path = Path("midicoder/stacks/angular/cp_full_audit_compliance/audit_log_list.component.ts.jinja2")
...
class TestReactUseAuditHook(TestCase):
    ...
    def setUp(self):
        self.template_path = Path("midicoder/stacks/react/cp_full_audit_compliance/useAudit.ts.jinja2")
...
class TestReactAuditLogListComponent(TestCase):
    ...
    def setUp(self):
        self.template_path = Path("midicoder/stacks/react/cp_full_audit_compliance/AuditLogList.tsx.jinja2")
...
class TestReactAuditTypes(TestCase):
    ...
    def setUp(self):
        self.template_path = Path("midicoder/stacks/react/cp_full_audit_compliance/types.ts.jinja2")
...
def _render_template(stack: str, template_name: str) -> str:
    ...
    template_path = _STACKS_DIR / stack / "core" / "cp_full_audit_compliance"
    try:
