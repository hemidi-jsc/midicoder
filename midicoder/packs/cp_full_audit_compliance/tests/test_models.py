...
class TestAuditTrail:
    ...
    def test_invalid_actor_type_raises_error(self):
        ...
        assert exc_info.value.code == ErrorCode.MDC-F12_AUDIT_INVALID_ACTOR_TYPE
    ...
    def test_empty_entity_type_raises_error(self):
        ...
        assert exc_info.value.code == ErrorCode.MDC-F12_AUDIT_EMPTY_ID
...
class TestAuditRule:
    ...
    def test_zero_retention_raises_error(self):
        ...
        assert exc_info.value.code == ErrorCode.MDC-F12_AUDIT_RETENTION_INVALID
    ...
    def test_archive_exceeds_retention_raises_error(self):
        ...
        assert exc_info.value.code == ErrorCode.MDC-F12_AUDIT_ARCHIVE_EXCEEDS_RETENTION
