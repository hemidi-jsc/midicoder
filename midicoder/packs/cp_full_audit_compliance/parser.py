...
class AuditComplianceParser:
    ...
    def parse(self, raw: str) -> AuditComplianceCollection:
        ...
        try:
            ...
            EM.raise_error(
                ErrorCode.MDC-BE01_DSL_PARSE_ERROR,
    ...
    def _parse_audit_rule(self, data: dict[str, Any]) -> AuditRule:
        ...
        """
        if not isinstance(data, dict):
            EM.raise_error(ErrorCode.MDC-BE01_DSL_PARSE_ERROR, message="Audit rule phải là YAML mapping")
        ...
        for action_str in actions_raw:
            try:
                ...
                EM.raise_error(
                    ErrorCode.MDC-F12_AUDIT_INVALID_ACTION,
                    action=action_str,
        ...
        try:
            ...
            EM.raise_error(
                ErrorCode.MDC-F12_AUDIT_INVALID_LEVEL,
                level=level_str,
    ...
    def _parse_compliance_control(self, data: dict[str, Any]) -> ComplianceControl:
        ...
        """
        if not isinstance(data, dict):
            EM.raise_error(ErrorCode.MDC-BE01_DSL_PARSE_ERROR, message="Compliance control phải là YAML mapping")
        ...
        try:
            ...
            EM.raise_error(
                ErrorCode.MDC-F12_AUDIT_CONTROL_INVALID_STANDARD,
        ...
        try:
            ...
            EM.raise_error(
                ErrorCode.MDC-F12_AUDIT_CONTROL_INVALID_TYPE,
        ...
        try:
            ...
            EM.raise_error(
                ErrorCode.MDC-F12_AUDIT_CONTROL_INVALID_ENFORCEMENT,
