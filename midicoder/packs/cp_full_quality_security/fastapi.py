...
class FastAPIQualityEmitter:
    ...
    def _generate_pyproject_quality(
        ...
        try:
            content = self.emitter.render(
                "cp_full_quality_security/pyproject_quality.toml.jinja2",
                {"profile": profile},
            )
    ...
    def _generate_bandit_config(
        ...
        try:
            content = self.emitter.render(
                "cp_full_quality_security/bandit.yaml.jinja2",
    ...
    def _generate_safety_policy(
        ...
        try:
            content = self.emitter.render(
                "cp_full_quality_security/safety_policy.json.jinja2",
                {"security_config": security_config},
            )
    ...
    def _generate_quality_gate(
        ...
        try:
            content = self.emitter.render(
                "cp_full_quality_security/quality_gate.py.jinja2",
                {
                    "profile": profile,
                    "security_config": security_config,
                },
    ...
    def _generate_flake8_config(
        ...
        try:
            content = self.emitter.render(
                "cp_full_quality_security/flake8.ini.jinja2",
                {"profile": profile},
            )
    ...
    def _generate_isort_config(
        ...
        try:
            content = self.emitter.render(
                "cp_full_quality_security/isort.cfg.jinja2",
                {"profile": profile},
            )
