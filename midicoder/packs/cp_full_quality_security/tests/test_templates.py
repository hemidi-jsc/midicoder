...
class TestTemplateDiscovery:
    ...
    def test_templates_exist(self, stack: str) -> None:
        ...
        template_dir = stacks_dir / stack / "core" / "cp_full_quality_security"
...
class TestTemplateContent:
    ...
    def test_fastapi_quality_gate_has_main_block(self) -> None:
        ...
        stacks_dir = _get_stacks_dir()
        tpl = stacks_dir / "fastapi" / "core" / "cp_full_quality_security" / "quality_gate.py.jinja2"
        if tpl.exists():
    ...
    def test_nestjs_eslintrc_has_security_plugin(self) -> None:
        ...
        stacks_dir = _get_stacks_dir()
        tpl = stacks_dir / "nestjs" / "core" / "cp_full_quality_security" / "eslintrc.json.jinja2"
        if tpl.exists():
            content = tpl.read_text(encoding="utf-8")
    ...
    def test_react_eslintrc_has_react_plugin(self) -> None:
        ...
        stacks_dir = _get_stacks_dir()
        tpl = stacks_dir / "react" / "core" / "cp_full_quality_security" / "eslintrc.json.jinja2"
        if tpl.exists():
            content = tpl.read_text(encoding="utf-8")
...
def _render_template(stack: str, template_name: str) -> str:
    ...
    template_path = _get_stacks_dir() / stack / "core" / "cp_full_quality_security"
    try:
