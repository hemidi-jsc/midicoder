...
# __file__ = .../midicoder/packs/cp_full_financial/tests/test_templates.py
# parent x6 = midicoder-ce/
MIDICODER_ROOT = Path(__file__).parent.parent.parent.parent.parent.parent

PACK_YML = MIDICODER_ROOT / "midicoder" / "emitters" / "core" / "cp_full_financial" / "pack.yml"

STACK_DIRS = {
    "fastapi": MIDICODER_ROOT / "midicoder" / "stacks" / "fastapi" / "core" / "cp_full_financial",
    "nestjs": MIDICODER_ROOT / "midicoder" / "stacks" / "nestjs" / "core" / "cp_full_financial",
    "angular": MIDICODER_ROOT / "midicoder" / "stacks" / "angular" / "core" / "cp_full_financial",
    "react": MIDICODER_ROOT / "midicoder" / "stacks" / "react" / "core" / "cp_full_financial",
}
...
class TestPackYML:
    ...
    def test_pack_internal_id(self):
        """Internal ID là cp_full_financial."""
        data = _load_pack()
        assert data["pack"]["internal_id"] == "cp_full_financial"
