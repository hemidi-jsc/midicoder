...
class TestProductStatus:
    ...
    def test_status_draft_value(self):
        from midicoder.packs.cp50_catalog.models import ProductStatus
...
class TestAttributeType:
    ...
    def test_type_string_value(self):
        from midicoder.packs.cp50_catalog.models import AttributeType
...
class TestSortOrder:
    ...
    def test_order_asc_value(self):
        from midicoder.packs.cp50_catalog.models import SortOrder
...
class TestVisibility:
    ...
    def test_visibility_public_value(self):
        from midicoder.packs.cp50_catalog.models import Visibility
...
class TestCategoryLevel:
    ...
    def test_level_root_value(self):
        from midicoder.packs.cp50_catalog.models import CategoryLevel
...
class TestProduct:
    ...
    def test_create_product_empty_product_id_raises(self):
        ...
        from midicoder.packs.cp50_catalog.models import Product
...
class TestCategory:
    ...
    def test_create_valid_category(self):
        ...
        from midicoder.packs.cp50_catalog.models import Category
        cat = Category(
            category_id="cat_001",
            name="Điện tử",
...
class TestProductVariant:
    ...
    def test_create_valid_variant(self):
        ...
        from midicoder.packs.cp50_catalog.models import ProductVariant
...
class TestAttributeDefinition:
    ...
    def test_create_attribute_empty_attribute_id_raises(self):
        ...
        from midicoder.packs.cp50_catalog.models import AttributeDefinition
        with pytest.raises(MidicoderError):
            AttributeDefinition(
                attribute_id="",
...
class TestAttributeValue:
    ...
    def test_create_valid_attribute_value(self):
        ...
        from midicoder.packs.cp50_catalog.models import AttributeValue
        av = AttributeValue(
...
class TestCatalogEngine:
    ...
    def _create_engine(self) -> "CatalogEngine":
        ...
        from midicoder.packs.cp50_catalog.models import CatalogEngine
