...
"""
    ...
    def test_parse_invalid_yaml_raises_error(self) -> None:
        ...
        assert exc_info.value.code == ErrorCode.CP24_DSL_PARSE_ERROR
    ...
    def test_parse_invalid_stack_raises_error(self) -> None:
        ...
        assert exc_info.value.code == ErrorCode.CP24_INVALID_STACK
    ...
    def test_parse_invalid_linter_raises_error(self) -> None:
        ...
        with pytest.raises(MidicoderError) as exc_info:
            self.parser.parse(data)
        assert exc_info.value.code == ErrorCode.CP24_PROFILE_INVALID
    ...
    def test_parse_empty_profile_name_raises_error(self) -> None:
        ...
        with pytest.raises(MidicoderError) as exc_info:
            self.parser.parse(data)
        assert exc_info.value.code == ErrorCode.CP24_EMPTY_PROFILE_NAME
    ...
    def test_parse_invalid_severity_raises_error(self) -> None:
        ...
        with pytest.raises(MidicoderError) as exc_info:
            self.parser.parse(data)
        assert exc_info.value.code == ErrorCode.CP24_SCAN_CONFIG_INVALID
