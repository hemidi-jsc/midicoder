...
STACK_DIRS = {
    "fastapi": STACKS_DIR / "fastapi" / "core" / "cp_full_plugin_system",
    "nestjs": STACKS_DIR / "nestjs" / "core" / "cp_full_plugin_system",
    "angular": STACKS_DIR / "angular" / "core" / "cp_full_plugin_system",
    "react": STACKS_DIR / "react" / "core" / "cp_full_plugin_system",
}
...
def _get_template_dir(stack: str) -> Path:
    ...
    return STACKS_DIR / stack / "core" / "cp_full_plugin_system"
...
def _render_template(stack: str, template_name: str, context: dict[str, Any]) -> str:
    ...
    template_path = f"cp_full_plugin_system/{template_name}"
