...
class EntityDiagramGenerator(DiagramGenerator):
    ...
    def _build_mermaid_source(self, domain: DomainIR) -> str:
        ...
        # Add relationships
        seen_edges = set()
        for source_id, target_id, field_name, is_array, is_optional, target_kind in relationships:
            edge_key = (source_id, target_id, field_name, is_array, is_optional, target_kind)
        ...
        for field in fields:
            ...
            if target_kind and target_id:
                relationships.append(
                    (source_id, target_id, field.name, is_array, is_optional, target_kind)
                )
