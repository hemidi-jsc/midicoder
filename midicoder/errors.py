...
class ErrorCode(str, Enum):
    ...
    # =========================================================================
    # B01: Domain Model DSL & IR Builder (MDC-B01-*)
    # =========================================================================
    B01_ENTITY_NOT_FOUND = "MDC-B01-001"
    B01_INVALID_FIELD_TYPE = "MDC-B01-002"
    B01_ENTITY_INVALID_FIELD = "MDC-B01-003"
    B01_ENTITY_INVALID_RELATIONSHIP = "MDC-B01-004"
    B01_ENTITY_INVALID_CONSTRAINT = "MDC-B01-005"
    B01_ENTITY_INVALID_LIFECYCLE = "MDC-B01-006"
    B01_COMMAND_NOT_FOUND = "MDC-B01-007"
    B01_QUERY_INVALID_FILTER = "MDC-B01-008"
    B01_QUERY_INVALID_PAGINATION = "MDC-B01-009"
    B01_VALUE_OBJECT_NOT_FOUND = "MDC-B01-010"
    B01_GUARD_TENANT_MISSING = "MDC-B01-011"
    B01_GUARD_TENANT_VIOLATION = "MDC-B01-012"
    B01_GUARD_USER_NOT_AUTHENTICATED = "MDC-B01-013"
    B01_GUARD_RATE_LIMIT_EXCEEDED = "MDC-B01-014"
    B01_GUARD_KYC_NOT_VERIFIED = "MDC-B01-015"
    B01_GUARD_AML_SCREENING_FAILED = "MDC-B01-016"
    B01_GUARD_HIPAA_NO_CLEARANCE = "MDC-B01-017"
    B01_GUARD_COMPLIANCE_LOG_FAILED = "MDC-B01-018"
    B01_GUARD_FRAUD_VELOCITY_EXCEEDED = "MDC-B01-019"
    B01_GUARD_FRAUD_AMOUNT_THRESHOLD = "MDC-B01-020"
    B01_GUARD_FRAUD_PATTERN_ANOMALY = "MDC-B01-021"
    B01_GUARD_FRAUD_EXTERNAL_BLOCKED = "MDC-B01-022"
    B01_GUARD_SAFETY_EQUIPMENT_UNSAFE = "MDC-B01-023"
    B01_GUARD_SAFETY_PERSONNEL_UNCERTIFIED = "MDC-B01-024"
    B01_GUARD_SAFETY_PROCESS_NON_COMPLIANT = "MDC-B01-025"
    B01_GUARD_SAFETY_HAZARD_DETECTED = "MDC-B01-026"
    B01_GUARD_CLAIMS_NOT_COVERED = "MDC-B01-027"
    B01_GUARD_CLAIMS_OUTSIDE_PERIOD = "MDC-B01-028"
    B01_GUARD_CLAIMS_EXCEEDS_LIMIT = "MDC-B01-029"
    B01_GUARD_CLAIMS_EXCLUDED = "MDC-B01-030"
    B01_TRANSACTION_NOT_ACTIVE = "MDC-B01-031"
    B01_TRANSACTION_COMMIT_FAILED = "MDC-B01-032"
    B01_TRANSACTION_ROLLBACK_FAILED = "MDC-B01-033"
    B01_GUARD_DOUBLE_ENTRY_IMBALANCE = "MDC-B01-034"
    B01_GUARD_PHI_NOT_ENCRYPTED = "MDC-B01-035"
    B01_GUARD_MINIMUM_NECESSARY_VIOLATION = "MDC-B01-036"
    B01_GUARD_EXTERNAL_API_TIMEOUT = "MDC-B01-037"
    B01_GUARD_FRAUD_EXTERNAL_TIMEOUT = "MDC-B01-038"
    ...
    CP49_COMM_CHANNEL_INVALID = "MDC-CP49-005"
    CP49_TENANT_POLICY_NOT_FOUND = "MDC-CP49-006"
    CP49_COOKIE_CATEGORY_INVALID = "MDC-CP49-007"
    CP49_CONSENT_EXPIRED_NEED_RENEW = "MDC-CP49-008"
